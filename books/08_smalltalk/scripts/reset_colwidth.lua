...
function Table(el)
  ...
  -- Bảng 2 cột cột đầu là "Vai" + cột Câu có caption (vd "Câu (GOOD)",
  -- "Câu (bản ĐÚNG)") → vẫn áp 20/80, không để auto-gen bóp cột Vai.
  ...
  -- Bảng CẤU TRÚC front matter (Phần|Tên|Nội dung) → 25/50/25 (class cố định)
  if hkey == "Phần|Tên|Nội dung" then
