# Hizashi Sách 08 — Trò chuyện thân thiết / 雑談・関係構築 — Mục lục 51 rules
...
Cast lõi như sách 06-07, **bổ sung 5 khách Nhật mới có quê khác nhau** để scenarios depth có thể vary theo vùng miền:

| Tên | 名前 | Vai | Quê quán | Đặc điểm |
|-----|-----|-----|---------|---------|
| anh Matsumoto | 松本PM | 白鷗 PM | Tokyo (đã có) | 50t, formal warm |
| anh Ōgaki | 大垣営業部長 | 白鷗 営業 | Osaka — Kansai dialect, khoái sumo | 55t |
| anh Nakamura | 中村CFO | 白鷗 CFO | Hokkaido — Sapporo, ưa thưởng beer + cá hồi | 55t |
| anh Tanaka | 田中PMO | 白鷗 PMO | Kanagawa | 35t |
| **anh Hiroshi** *(MỚI)* | **広島部長 (広島さん)** | 白鷗 関西支店長 | **Hiroshima** — Carp fan, okonomiyaki, oysters | 50t |
| **chị Yamamoto** *(MỚI)* | **山本マネージャー** | 白鷗 大阪 BD | **Osaka** — Kansai, food blogger, takoyaki | 38t |
| **anh Sato** *(MỚI)* | **佐藤先生** | 白鷗 福岡支店 lead | **Fukuoka (Kyushu)** — Hawks fan, tonkotsu, shochu | 60t senior |
| **anh Kobayashi** *(MỚI)* | **小林さん** | 白鷗 沖縄出張担当 | **Okinawa** — Different culture | 45t |
| **anh Ito** *(MỚI)* | **伊藤さん** | 白鷗 名古屋支店 | **Nagoya (Aichi)** — miso culture, Toyota mindset | 48t |
| **anh Kato** *(MỚI)* | **加藤さん** | 白鷗 中部協力先 | **Gifu — Hida-Takayama** — 飛騨牛 fan, traditional crafts (関の刃物 / 美濃焼), 白川郷 native | 52t |

→ Cast nâng từ 13 → 19 speakers. Mỗi rule regional có specific khách phù hợp quê.

Bối cảnh: Phase 3 đã ký xong (sách 06), Dũng + Tuấn đang travel Nhật nhiều tour customer + dinner. Cơ hội xây quan hệ depth.

---

## 📋 Cấu trúc 5 phần × 51 rules
...
## Phần I — Khung tư duy 雑談 — 8 rules
...
## Phần III — Regional deep dive (47 prefectures) — 13 rules **[ĐẶC SẮC NHẤT]**

*Đây là phần user yêu cầu chiều sâu — không hời hợt. Mỗi rule có "regional cheat sheet" template với đặc sản / sport team / lễ hội / dialect / phrase đặc trưng.*
...
## Phần V — Drinking culture + Advanced + Self-improve — 10 rules
...
- **Sách 03 rule_27** 雑談 (basic) → **expanded toàn bộ sách 08**
- **Sách 06 rule_27** dinner conversation → **deep cover sách 08 phần V**
- **Sách 07 rule_26** kanpai etiquette → cross-ref rule 42 sách 08
- **Sách 07 rule_24-30** dinner host/guest → connect với sách 08 rules 41-45

---

## 📐 Format đặc thù sách 08

- Schema v3 — thêm field gợi ý: `regional_focus` (string, optional) cho Phần III
- **Phụ lục E mới** — Regional Cheat Sheet ready-to-print 47 tỉnh
- Cast +5 speakers (Hiroshi/Yamamoto/Sato/Kobayashi/Ito) → voice_profiles.json extend

---

## 🎯 Why này quan trọng

Sách 02-07 dạy survival + competence — bạn KHÔNG fail. Sách 08 dạy bạn **chuyển từ vendor → đối tác tin cậy**. Đa số người Việt làm khách Nhật stuck ở mức "polite professional" và không tiến lên được vì 雑談 yếu — không có kho knowledge về regional / cultural depth để nói chuyện sâu.

Khách Nhật senior 50-60 tuổi cực kỳ trân trọng việc đối tác nhớ quê quán + đặc sản + sport team của họ. Đây là **moat** mà AI tools không thay thế được — nó là human connection.

---

## 📅 Estimate

- 51 rules với regional research = sách phức tạp nhất bộ → 8-10 tuần content writing
- 3 review pass + native JP review (đặc biệt regional dialect — Hiroshima-ben, Kansai-ben, Hakata-ben, Hida dialect)
- Ước v1.0 ready: 12-14 tuần
