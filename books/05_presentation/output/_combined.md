...
> **Luận điểm.** Mỗi slide chỉ tải **1 điểm cốt lõi**. Title không phải chủ đề ("売上について") mà là kết luận ("Q2売上はQ1比+18%"). Người nghe Nhật quét slide trong 3 giây — nếu không thấy ngay thông điệp, slide vô dụng.
>
...
Sau khi điền xong 7問, Dũng quay lại với bản thảo 15 slide. Mỗi slide có title kiểu "Phase 3 について", "システム構成について" — toàn chủ đề, không có kết luận. Chị Hương xem lại trước buổi diễn thử.

---

## Trường hợp xấu — title là chủ đề

*chia sẻ màn hình*

| Vai | Câu |
|---------|-----|
| **ズン** | 「フオン<ruby>副部長<rt>ふくぶちょう</rt></ruby>、スライド10枚に<ruby>絞<rt>しぼ</rt></ruby>りました。タイトルご<ruby>確認<rt>かくにん</rt></ruby>ください。」 <br/>*Chị Hương, em đã rút xuống còn 10 slide. Phiền chị xem qua title giúp em ạ.* |
...
| **フオン** | 「だから『何を』をタイトルに書く。**1スライド1メッセージ**。タイトル＝<ruby>結論<rt>けつろん</rt></ruby>。<ruby>聴衆<rt>ちょうしゅう</rt></ruby>はタイトルだけ見て分かるべき。」 <br/>*Đó, viết 『cái gì』 vào title. Một slide một message. Title = kết luận. Khán giả chỉ nhìn title là phải hiểu.* |

**Vì sao xấu:** Title kiểu 「〜について」 chỉ nêu chủ đề chứ không truyền thông điệp. Khách Nhật xem bộ slide nhanh (3 giây/slide) — nếu title chỉ là chủ đề, họ phải đọc nội dung phần thân → mệt → mất tập trung.

---

## Trường hợp tốt — title là kết luận

| Vai | Câu |
|---------|-----|
| **ズン** | 「フオン副部長、タイトルを全部**<ruby>結論型<rt>けつろんがた</rt></ruby>**に書き<ruby>直<rt>なお</rt></ruby>しました【1】。10枚お願いします。」 <br/>*Chị Hương, em đã sửa toàn bộ title sang dạng kết luận ạ. Phiền chị rà soát 10 slide giúp em.* |
| **フオン** | 「『Phase 3 で<ruby>在庫<rt>ざいこ</rt></ruby><ruby>差異<rt>さい</rt></ruby>を<ruby>月平均<rt>つきへいきん</rt></ruby>5%→1%に<ruby>削減<rt>さくげん</rt></ruby>』… うん、これなら**タイトルだけ読めば結論が分かる**。本文は何？」 <br/>*「Phase 3 giảm sai lệch tồn kho từ 5%/tháng xuống 1%」... ờ, thế này chỉ cần đọc title là hiểu kết luận. Phần thân em viết gì?* |
...
>
> *Title = kết luận, phần thân = 3 luận cứ. Còn lại cắt sang slide khác.*
...
# Rule 06 — Quy tắc mật độ (10-20-30) / 密度ルール
...
# Rule 08 — 30 giây mở đầu thu hút / 30秒オープニング
...
| 構える | かまえる | CẤU | Sẵn sàng (cầm bút v.v.) |
...
# Rule 10 — Bối cảnh + trình bày chương trình / 背景＋アジェンダ発話
...
# Rule 12 — Tạo bầu không khí cho khách Nhật điềm đạm / 日本顧客向けムード作り
...
| 再発予防 | さいはつよぼう | TÁI PHÁT DỰ PHÒNG | Phòng ngừa tái phát |
...
# Rule 17 — So sánh phương án (bảng so sánh) / 比較マトリクス
...
| ご意見 | ごいけん | Ý KIẾN | Ý kiến (tôn kính) |
...
| 不明な点 | ふめいなてん | BẤT MINH | Điểm chưa rõ |
...
| **ズン** | 「あ、それは…<ruby>後<rt>あと</rt></ruby>で<ruby>確認<rt>かくにん</rt></ruby>します…」 *(không deadline)* <br/>*À, cái đó... em sẽ kiểm tra sau ạ...* |
...
# Rule 25 — Đối phó câu hỏi gay gắt / 敵対的質問への切り返し
...
| **ズン** | 「①Phase 3 はスコープが Phase 2 の 1.6倍 (<ruby>機能数<rt>きのうすう</rt></ruby> 12→19)、②セキュリティ<ruby>要件<rt>ようけん</rt></ruby> ISO27001 <ruby>対応<rt>たいおう</rt></ruby>で <ruby>工数<rt>こうすう</rt></ruby>+15%、③24/7 サポート<ruby>初年度<rt>しょねんど</rt></ruby><ruby>込<rt>こ</rt></ruby>み。**スコープ<ruby>単価<rt>たんか</rt></ruby>で見ますと Phase 2 <ruby>比<rt>ひ</rt></ruby> -8%** でございます。<ruby>詳細<rt>しょうさい</rt></ruby>はスライド19の<ruby>比較表<rt>ひかくひょう</rt></ruby>のとおりです。」 — Trả lời đánh số <br/>*① Phase 3 scope gấp 1.6 lần Phase 2 (12 chức năng → 19), ② yêu cầu bảo mật ISO27001 = effort +15%, ③ bao gồm support 24/7 năm đầu. Tính theo đơn giá scope thì giảm 8% so với Phase 2 ạ. Chi tiết ở slide 19 bảng so sánh ạ.* |
| **ズン** | 「**もしスコープを Phase 2 と<ruby>同等<rt>どうとう</rt></ruby>に<ruby>絞<rt>しぼ</rt></ruby>れば** 950万まで<ruby>圧縮<rt>あっしゅく</rt></ruby><ruby>可能<rt>かのう</rt></ruby>です。**いずれの<ruby>方向性<rt>ほうこうせい</rt></ruby>をご<ruby>希望<rt>きぼう</rt></ruby>でしょうか**【3】？」 <br/>*Nếu cắt scope về tương đương Phase 2, có thể nén xuống 9,5 triệu yên ạ. Quý vị muốn theo hướng nào ạ?* |
| **大垣** | 「…なるほど、スコープ単価で -8% か。比較表をもう一度見せてください。」 <br/>*...Hiểu rồi, đơn giá scope giảm 8% à. Cho tôi xem lại bảng so sánh.* |
...
| 頂戴 | ちょうだい | ĐỈNH ĐỚI | (Khiêm) nhận / xin |
...
| 直リンク | ちょくリンク | TRỰC | Liên kết trực tiếp |
...
| 失効 | しっこう | THẤT HIỆU | Hết hiệu lực |
...
*Tổng hợp cụm câu chốt từ tất cả 60 rules. Sắp xếp theo phần để tiện tra cứu khi soạn / luyện.*
...
>
>  *Em đã điền 7 câu hỏi chuẩn bị bài thuyết trình ạ. Phiền chị duyệt giúp em được không ạ?*
>
>  _プレゼン準備レビュー依頼の標準_
...
>
>  *Em ghi đầu ra là 〇〇, nhưng nếu chỉ đạt được 〜 thì có ổn không ạ?*
>
>  _現実的アウトプットラインの自己点検_
...
>  「本文は根拠3点だけに絞りました。」
>
>  *Phần thân em chỉ rút lại còn 3 luận cứ ạ.*
>
>  _本文の3点絞り込み報告_
...
>
>  *Em đã giới hạn còn 3 màu ạ. Màu nhấn em dùng màu thương hiệu Hakuō.*
>
>  _色彩設計の説明_


### Rule 06 — Quy tắc mật độ (10-20-30) / 密度ルール (10-20-30)

**ズン (em Dũng):**

>  「本編10枚、appendix 5枚の構成です。」
>
>  *Cấu trúc gồm phần thân 10 slide, phụ lục 5 slide ạ.*
>
>  _10-20-30 構成の説明_


### Rule 07 — Phương án dự phòng (Plan B) / バックアップ計画 (Plan B)
...
>
>  *Hôm nay em xin trình bày với tư cách người phụ trách chính 〇〇 ạ. Em đang phụ trách 〇〇, dự án lần này là phần kế tiếp của đó ạ.*
>
>  _プレゼン自己紹介3文テンプレ_
...
>
>  *Hôm nay quý vị đã dành cho em khung 〇 phút ạ. Cấu trúc gồm thuyết trình 〇 phút, Q&A 〇 phút.*
>
>  _時間配分の口頭コミット_
...
>
>  *Trước báo giá em xin trình bày 3 điểm ạ. Neo giá, Bậc giá, ROI ạ.*
>
>  _価格スライド導入_
...
### Rule 20 — Rủi ro & biện pháp đối phó / リスクと対策
...
>
>  *Có 〇 mốc ạ, người phụ trách mỗi mốc là 〇〇 bên em + 〇〇 bên quý vị ạ.*
>
...
>
>  *Em không thể trả lời ngay tại chỗ ạ. Em sẽ xác nhận với 〇〇 và phản hồi trước 〇 ạ.*
>
...
>
>  *Bước tiếp theo 3 mục: trước 〇〇 thì 〇〇, trước 〇〇 thì 〇〇, trước 〇〇 thì 〇〇.*
>
>  _CTA numbered 標準_
...
>
>  *Em hoàn tất thiết lập 5 yếu tố ạ: góc mắt camera, chiếu sáng, giọng, mic, phông nền.*
>
...
>
>  *Câu hỏi từ chat phiền 〇〇 san chuyển lời bằng giọng nói giúp em.*
>
...
>
>  *Trước tiên quý vị trực tuyến, âm thanh và hình ảnh có vấn đề gì không ạ?*
>
...
>
>  *Xin lỗi quý vị, vừa phát sinh sự cố ~. Em xin phép chuyển sang quy trình khôi phục ạ.*
>
...
>
>  *Đang khôi phục nhưng em xin phép tiếp tục nội dung ạ.*
>
>  _Tiếp tục bằng lời trong khi khôi phục_
...
>
>  _Câu bắc cầu bàn giao người đồng trình bày chuẩn_
...
>
>  _Xác nhận tiếp nhận bàn giao ngắn gọn_
...
>
>  *Hôm nay em xin phép quay video buổi này ạ. Em xin sự đồng ý của tất cả rồi mới bắt đầu quay ạ.*
>
>  _REC 全員同意取得_
...
### Rule 34 — Tự đánh giá sau bài thuyết trình / 自己評価
...
>
>  _Báo cáo kết quả tự đánh giá chuẩn_

**ズン (em Dũng):**

>  「〇〇までに〇〇 drill、〇〇までに〇〇 暗唱完了いたします。」
>
>  *Trước 〇〇 em luyện xong 〇〇, trước 〇〇 em thuộc xong 〇〇 ạ.*
>
>  _Cam kết hạn chót + luyện tập cho điểm cần cải thiện_
...
>
>  *Chu kỳ sau em đi: Tập dượt có quay + Thử nghiệm đồng nghiệp + Thử nghiệm cấp cao + Thuyết trình thật + Nhóm nhìn lại ạ.*
>
>  _Cam kết chu kỳ 4 bước đầy đủ_

**フオン副部長 (chị Hương):**

>  「次サイクルまでに rubric 平均 〇/5 を目標にする。」
>
>  *Đến chu kỳ sau mục tiêu trung bình bảng tiêu chí 〇/5.*
>
>  _Đặt mục tiêu định lượng_
...
|------|------|------|------|------|
| 準備 | じゅんび | CHUẨN BỊ | Chuẩn bị | rule_01 |
| 聴衆 | ちょうしゅう | THÍNH CHÚNG | Khán giả | rule_01 |
| 決裁者 | けっさいしゃ | QUYẾT TÀI GIẢ | Người quyết định | rule_01 |
| アウトプット | アウトプット | — | Đầu ra / kết quả | rule_01 |
| バックアップ | バックアップ | — | Dự phòng | rule_01 |
| 妥協 | だきょう | THỎA HIỆP | Thỏa hiệp / compromise | rule_01 |
| 譲れない | ゆずれない | NHƯỢNG | Không thể nhượng bộ | rule_01 |
| 結論 | けつろん | KẾT LUẬN | Kết luận | rule_02 |
| 根拠 | こんきょ | CĂN CỨ | Luận cứ / căn cứ | rule_02 |
| 削減 | さくげん | TƯỚC GIẢM | Cắt giảm | rule_02 |
| 認知負荷 | にんちふか | NHẬN TRI PHỤ HÀ | Tải nhận thức | rule_02 |
| 改善 | かいぜん | CẢI THIỆN | Cải thiện | rule_02 |
| スキャン | スキャン | — | Quét nhanh | rule_02 |
| 共通認識 | きょうつうにんしき | CỘNG THÔNG NHẬN THỨC | Nhận thức chung | rule_03 |
| 問題発生 | もんだいはっせい | VẤN ĐỀ PHÁT SINH | Vấn đề phát sinh | rule_03 |
| 誘導 | ゆうどう | DỤ ĐẠO | Dẫn dắt | rule_03 |
| 再発 | さいはつ | TÁI PHÁT | Tái phát | rule_03 |
| 隠す | かくす | ẨN | Che giấu | rule_03 |
| 圧縮 | あっしゅく | ÁP SÚC | Nén / cô đọng | rule_03 |
| 視覚階層 | しかくかいそう | THỊ GIÁC GIAI TẦNG | Phân cấp trực quan | rule_04 |
| フォント | フォント | — | Font | rule_04 |
| 揃え | そろえ | — | Alignment | rule_04 |
| 余白 | よはく | DƯ BẠCH | Margin / white space | rule_04 |
| 行間 | ぎょうかん | HÀNH GIAN | Line spacing | rule_04 |
| 潰れる | つぶれる | — | Bị bể / mờ (chữ) | rule_04 |
| プロジェクター | プロジェクター | — | Máy chiếu | rule_04 |
| 色彩 | しきさい | SẮC THÁI | Màu sắc | rule_05 |
| 保守的 | ほしゅてき | BẢO THỦ | Bảo thủ / conservative | rule_05 |
| 老舗 | しにせ | LÃO PHÓ | Công ty truyền thống lâu đời | rule_05 |
| 派手 | はで | — | Sặc sỡ / lòe loẹt | rule_05 |
| 警告 | けいこく | CẢNH CÁO | Cảnh báo | rule_05 |
| 装飾 | そうしょく | TRANG SỨC | Trang trí | rule_05 |
| 軽薄 | けいはく | KHINH BẠC | Nhẹ dạ / nông nổi | rule_05 |
| アクセント | アクセント | — | Accent (màu nhấn) | rule_05 |
| 密度 | みつど | MẬT ĐỘ | Mật độ | rule_06 |
| 念のため | ねんのため | NIỆM | Cho chắc / phòng hờ | rule_06 |
| 削られる | けずられる | — | Bị cắt giảm | rule_06 |
| 監査 / audit | かんさ | GIÁM TRA | Kiểm tra / soát | rule_06 |
| 死守 | ししゅ | TỬ THỦ | Bảo vệ tới cùng | rule_06 |
| 追加 | ついか | TRUY GIA | Thêm vào | rule_06 |
| 復旧 | ふっきゅう | PHỤC CỰU | Khôi phục | rule_07 |
| 慌てる | あわてる | — | Hoảng loạn | rule_07 |
| 紛失 | ふんしつ | PHÂN THẤT | Thất lạc / mất | rule_07 |
| 保険 | ほけん | BẢO HIỂM | Bảo hiểm / dự phòng | rule_07 |
| 配布 | はいふ | PHỐI BỐ | Phát tài liệu | rule_07 |
| テザリング | テザリング | — | Chia sẻ mạng di động / phát Wi-Fi từ điện thoại | rule_07 |
| アダプタ | アダプタ | — | Adapter | rule_07 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Rule |
|------|------|------|------|------|
| 残課題 | ざんかだい | TỒN KHÓA ĐỀ | Vấn đề còn lại | rule_08 |
| 方向性 | ほうこうせい | PHƯƠNG HƯỚNG TÍNH | Hướng đi | rule_08 |
| 集中 | しゅうちゅう | TẬP TRUNG | Tập trung | rule_08 |
| 痛み | いたみ | THỐNG | Pain (point) | rule_08 |
| 構える | かまえる | CẤU | Sẵn sàng (cầm bút etc) | rule_08 |
| 主担当 | しゅたんとう | CHỦ ĐẢM ĐƯƠNG | Người phụ trách chính | rule_09 |
| 継続 | けいぞく | KẾ TỤC | Tiếp tục / kế thừa | rule_09 |
| 任される | まかされる | NHẬM | Được giao trách nhiệm | rule_09 |
| 実績 | じっせき | THỰC TÍCH | Thành tích / kinh nghiệm | rule_09 |
| 信頼性 | しんらいせい | TÍN LẠI TÍNH | Độ tin cậy (credibility) | rule_09 |
| 専門家 | せんもんか | CHUYÊN MÔN GIA | Chuyên gia | rule_09 |
| 背景 | はいけい | BỐI CẢNH | Bối cảnh | rule_10 |
| 論点 | ろんてん | LUẬN ĐIỂM | Vấn đề / điểm bàn | rule_10 |
| 構成 | こうせい | CẤU THÀNH | Cấu trúc | rule_10 |
| 第1部 | だいいちぶ | ĐỆ NHẤT BỘ | Phần 1 | rule_10 |
| ゴール | ゴール | — | Goal | rule_10 |
| 振り返り | ふりかえり | — | Nhìn lại / retrospective | rule_10 |
| 分析 | ぶんせき | PHÂN TÍCH | Phân tích | rule_10 |
| 滑る | すべる | HOẠT | Trượt (joke fail / không hấp dẫn) | rule_11 |
| 中小企業 | ちゅうしょうきぎょう | TRUNG TIỂU KI NGHIỆP | Doanh nghiệp vừa và nhỏ | rule_11 |
| 議論モード | ぎろんモード | NGHỊ LUẬN | Chế độ thảo luận | rule_11 |
| 驚き | おどろき | KINH | Sự ngạc nhiên | rule_11 |
| 修辞疑問 | しゅうじぎもん | TU TỪ NGHI VẤN | Câu hỏi tu từ | rule_11 |
| 着実 | ちゃくじつ | TRƯỚC THỰC | Chắc chắn từng bước | rule_12 |
| 確実 | かくじつ | XÁC THỰC | Chắc chắn | rule_12 |
| 丁寧 | ていねい | ĐINH NINH | Cẩn thận / chỉn chu | rule_12 |
| 堅実 | けんじつ | KIÊN THỰC | Vững chắc | rule_12 |
| 胡散臭い | うさんくさい | — | Đáng ngờ / mờ ám | rule_12 |
| 売り急ぎ | うりいそぎ | — | Vội bán hàng | rule_12 |
| 革命的 | かくめいてき | CÁCH MẠNG | Cách mạng (hype word) | rule_12 |
| 詐欺 | さぎ | TRÁ KHI | Lừa đảo | rule_12 |
| 枠 | わく | — | Khung giờ / suất giờ | rule_13 |
| 切り替え | きりかえ | THIẾT CẢI | Chuyển đổi | rule_13 |
| 経過 | けいか | KINH QUÁ | Đã trôi qua | rule_13 |
| タイマー | タイマー | — | Đồng hồ đếm giờ | rule_13 |
| 可視化 | かしか | KHẢ THỊ HÓA | Trực quan hóa | rule_13 |
| 頑張って | がんばって | — | Cố gắng (vague — tránh khi commit) | rule_13 |
| 好印象 | こういんしょう | HẢO ẤN TƯỢNG | Ấn tượng tốt | rule_13 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Rule |
|------|------|------|------|------|
| 論理マーカー | ろんりマーカー | LUẬN LÝ | Từ đánh dấu logic | rule_14 |
| 続いて | つづいて | — | Tiếp theo | rule_14 |
| まとめる | まとめる | — | Tổng kết / gói lại | rule_14 |
| 補足 | ほそく | BỔ TÚC | Bổ sung / supplement | rule_14 |
| 高度化 | こうどか | CAO ĐỘ HÓA | Nâng cao / sophistication | rule_14 |
| 再発予防 | さいはつよぼう | TÁI PHÁT DỰ PHÒNG | Phòng ngừa tái phát | rule_14 |
| 棒グラフ | ぼうグラフ | BỔNG | Biểu đồ cột | rule_15 |
| 折れ線グラフ | おれせんグラフ | CHIẾT TUYẾN | Biểu đồ đường | rule_15 |
| 円グラフ | えんグラフ | VIÊN | Biểu đồ tròn (pie) | rule_15 |
| 散布図 | さんぷず | TÁN BỐ ĐỒ | Biểu đồ phân tán | rule_15 |
| 出典 | しゅってん | XUẤT ĐIỂN | Nguồn | rule_15 |
| 集計 | しゅうけい | TẬP KẾ | Tổng hợp số liệu | rule_15 |
| 注記 | ちゅうき | CHÚ KÝ | Chú thích | rule_15 |
| 差異率 | さいりつ | SAI DỊ SUẤT | Tỷ lệ sai lệch | rule_15 |
| ナレーション | ナレーション | — | Narration / lồng tiếng | rule_16 |
| 操作 | そうさ | THAO TÁC | Thao tác | rule_16 |
| 承認 | しょうにん | THỪA NHẬN | Phê duyệt | rule_16 |
| 検出 | けんしゅつ | KIỂM XUẤT | Phát hiện | rule_16 |
| 倉庫担当 | そうこたんとう | THƯƠNG KHỐ ĐẢM ĐƯƠNG | Phụ trách kho | rule_16 |
| 効果実感 | こうかじっかん | HIỆU QUẢ THỰC CẢM | Cảm nhận hiệu quả | rule_16 |
| 対比 | たいひ | ĐỐI TỈ | Đối chiếu | rule_16 |
| 比較マトリクス | ひかくマトリクス | TỈ GIẢO | Bảng so sánh | rule_17 |
| 評価軸 | ひょうかじく | BÌNH GIÁ TRỤC | Tiêu chí đánh giá | rule_17 |
| 推奨 | すいしょう | SUY TƯỞNG | Khuyến nghị | rule_17 |
| 運用負荷 | うんようふか | VẬN DỤNG PHỤ HÀ | Tải vận hành | rule_17 |
| 投資額対効果 | とうしがくたいこうか | ĐẦU TƯ NGẠCH ĐỐI HIỆU QUẢ | Hiệu quả trên đầu tư | rule_17 |
| 責任放棄 | せきにんほうき | TRÁCH NHẬM PHÓNG KHỨ | Bỏ trách nhiệm | rule_17 |
| 絞り込む | しぼりこむ | — | Thu hẹp lại | rule_17 |
| 顧客の声 | こきゃくのこえ | CỐ KHÁCH | Tiếng nói khách hàng | rule_18 |
| 事例 | じれい | SỰ LỆ | Tình huống thực tế | rule_18 |
| 引用 | いんよう | DẪN DỤNG | Trích dẫn | rule_18 |
| 匿名 | とくめい | ẨN DANH | Ẩn danh | rule_18 |
| 月末締め | げつまつじめ | NGUYỆT MẠT | Chốt cuối tháng | rule_18 |
| 残業 | ざんぎょう | TÀN NGHIỆP | Tăng ca | rule_18 |
| 大手 | おおて | ĐẠI THỦ | Lớn / major | rule_18 |
| 見積り | みつもり | — | Báo giá | rule_19 |
| 投資回収 | とうしかいしゅう | ĐẦU TƯ HỒI THU | Hoàn vốn | rule_19 |
| 削減効果 | さくげんこうか | TƯỚC GIẢM HIỆU QUẢ | Hiệu quả cắt giảm | rule_19 |
| 業界平均 | ぎょうかいへいきん | NGHIỆP GIỚI BÌNH QUÂN | Trung bình ngành | rule_19 |
| 反論 | はんろん | PHẢN LUẬN | Phản biện | rule_19 |
| 付帯 | ふたい | PHÓ ĐỚI | Đi kèm | rule_19 |
| 累計 | るいけい | LŨY KẾ | Cộng dồn | rule_19 |
| 折れる | おれる | — | Bị bẻ / chùn (đàm phán) | rule_19 |
| 発生確率 | はっせいかくりつ | PHÁT SINH XÁC SUẤT | Xác suất xảy ra | rule_20 |
| 影響度 | えいきょうど | ẢNH HƯỞNG ĐỘ | Mức độ ảnh hưởng | rule_20 |
| 対策 | たいさく | ĐỐI SÁCH | Đối sách | rule_20 |
| 監査 | かんさ | GIÁM TRA | Kiểm toán / audit | rule_20 |
| 並行 | へいこう | TỊNH HÀNH | Song song | rule_20 |
| 移行 | いこう | DI HÀNH | Di chuyển / migrate | rule_20 |
| 欠損 | けっそん | KHUYẾT TỔN | Thiếu / mất mát | rule_20 |
| 要警戒 | ようけいかい | YẾU CẢNH GIỚI | Cần cảnh giác | rule_20 |
| ロードマップ | ロードマップ | — | Lộ trình | rule_21 |
| マイルストーン | マイルストーン | — | Cột mốc | rule_21 |
| 成果物 | せいかぶつ | THÀNH QUẢ VẬT | Sản phẩm đầu ra | rule_21 |
| 要件定義 | ようけんていぎ | YẾU KIỆN ĐỊNH NGHĨA | Định nghĩa yêu cầu | rule_21 |
| sign-off | sign-off | — | Phê duyệt cuối | rule_21 |
| 前提条件 | ぜんていじょうけん | TIỀN ĐỀ ĐIỀU KIỆN | Điều kiện tiên quyết | rule_21 |
| 半信半疑 | はんしんはんぎ | BÁN TÍN BÁN NGHI | Bán tín bán nghi | rule_21 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Rule |
|------|------|------|------|------|
| 質疑応答 | しつぎおうとう | CHẤT NGHI ỨNG ĐÁP | Q&A | rule_22 |
| 沈黙 | ちんもく | TRẦM MẶC | Sự im lặng | rule_22 |
| 挙手 | きょしゅ | CỬ THỦ | Giơ tay | rule_22 |
| 構いません | かまいません | — | Không sao / không vấn đề | rule_22 |
| 承る | うけたまわる | — | (Khiêm) tiếp nhận, lắng nghe | rule_22 |
| ご意見 | ごいけん | Ý KIẾN | Ý kiến (tôn kính) | rule_22 |
| 趣旨 | しゅし | THÚ CHỈ | Ý chính / chủ đích | rule_23 |
| 重複 | ちょうふく | TRÙNG PHỤC | Trùng / overlap | rule_23 |
| 調整 | ちょうせい | ĐIỀU CHỈNH | Điều phối | rule_23 |
| 責任者 | せきにんしゃ | TRÁCH NHẬM GIẢ | Người phụ trách | rule_23 |
| 傾聴 | けいちょう | KHUYNH THÍNH | Lắng nghe (active) | rule_23 |
| 月次 | げつじ | NGUYỆT THỨ | Hàng tháng | rule_23 |
| 不明な点 | ふめいなてん | BẤT MINH | Điểm chưa rõ | rule_23 |
| 持ち帰る | もちかえる | — | Mang về (xem xét) | rule_24 |
| 確認 | かくにん | XÁC NHẬN | Xác nhận | rule_24 |
| 即答 | そくとう | TỨC ĐÁP | Trả lời ngay | rule_24 |
| 〜かねます | — | — | Không thể (formal) | rule_24 |
| 営業日 | えいぎょうび | DOANH NGHIỆP NHẬT | Ngày làm việc | rule_24 |
| 期限 | きげん | KỲ HẠN | Hạn | rule_24 |
| 認証 | にんしょう | NHẬN CHỨNG | Xác thực | rule_24 |
| 統合 | とうごう | THỐNG HỢP | Tích hợp | rule_24 |
| 敵対的 | てきたいてき | ĐỊCH ĐỐI | Đối nghịch / hostile | rule_25 |
| 切り返す | きりかえす | — | Đáp trả khéo | rule_25 |
| ご指摘 | ごしてき | CHỈ TRÍCH | Sự chỉ ra (kính ngữ) | rule_25 |
| もっとも | — | — | Hợp lý / có lý | rule_25 |
| ご懸念 | ごけねん | HUYỀN NIỆM | Mối quan ngại (kính) | rule_25 |
| 妥当性 | だとうせい | THỎA ĐƯƠNG TÍNH | Tính hợp lý | rule_25 |
| 内訳 | うちわけ | NỘI DỊCH | Phân tích chi tiết | rule_25 |
| クロージング | クロージング | — | Closing | rule_26 |
| まとめ | まとめ | — | Tóm tắt / recap | rule_26 |
| 次のステップ | つぎのステップ | — | Next step | rule_26 |
| 都合 | つごう | ĐÔ HỢP | Sự thuận tiện | rule_26 |
| 法務 | ほうむ | PHÁP VỤ | Pháp chế | rule_26 |
| サインオフ | サインオフ | — | Sign-off | rule_26 |
| 議事メモ | ぎじメモ | NGHỊ SỰ | Meeting note | rule_26 |
| 頂戴 | ちょうだい | ĐỈNH ĐỚI | (Khiêm) nhận / xin | rule_26 |
| 謝辞 | しゃじ | TẠ TỪ | Lời cảm ơn | rule_27 |
| 連絡先 | れんらくさき | LIÊN LẠC TIÊN | Contact | rule_27 |
| 閲覧 | えつらん | DUYỆT LÃM | Xem (read-only) | rule_27 |
| 営業時間 | えいぎょうじかん | DOANH NGHIỆP THỜI GIAN | Giờ làm việc | rule_27 |
| 退室 | たいしつ | THOÁI THẤT | Rời phòng | rule_27 |
| 情報密度 | じょうほうみつど | TÌNH BÁO MẬT ĐỘ | Mật độ thông tin | rule_27 |
| 直リンク | ちょくリンク | TRỰC | Direct link | rule_27 |
| 事後 | じご | SỰ HẬU | Sau (sự việc) | rule_28 |
| 御礼 | おれい | NGỰ LỄ | Lời cảm ơn | rule_28 |
| 件名 | けんめい | KIỆN DANH | Tiêu đề mail | rule_28 |
| 添付 | てんぷ | THIÊM PHÓ | Đính kèm | rule_28 |
| 引き続き | ひきつづき | DẪN TỤC | Tiếp tục (formal) | rule_28 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Rule |
|------|------|------|------|------|
| カメラ目線 | かめらめせん | — | Giao tiếp bằng mắt qua camera | rule_29 |
| 逆光 | ぎゃっこう | NGHỊCH QUANG | Ngược sáng | rule_29 |
| 照明 | しょうめい | CHIẾU MINH | Đèn / lighting | rule_29 |
| ピンマイク | ピンマイク | — | Mic ve áo / lavalier | rule_29 |
| 共有 | きょうゆう | CỘNG HỮU | Share (screen) | rule_29 |
| モデレーター | モデレーター | — | Moderator | rule_29 |
| ハイブリッド | ハイブリッド | — | Kết hợp | rule_30 |
| 室内 | しつない | THẤT NỘI | Trong phòng | rule_30 |
| 復唱 | ふくしょう | PHỤC XƯỚNG | Lặp lại | rule_30 |
| 切替 | きりかえ | THIẾT CẢI | Chuyển đổi | rule_30 |
| 達成率 | たっせいりつ | ĐẠT THÀNH SUẤT | Tỉ lệ đạt | rule_30 |
| クリア | クリア | — | Rõ (sound) | rule_30 |
| 優先する | ゆうせんする | ƯU TIÊN | Ưu tiên | rule_30 |
| トラブル | トラブル | — | Trouble / sự cố | rule_31 |
| ハンドアウト | ハンドアウト | — | Tài liệu phát | rule_31 |
| お騒がせ | おさわがせ | — | Phiền hà / xáo trộn | rule_31 |
| 引き継ぎ | ひきつぎ | DẪN KẾ | Bàn giao / handoff | rule_32 |
| 共同 | きょうどう | CỘNG ĐỒNG | Cộng tác / chung | rule_32 |
| バトンタッチ | バトンタッチ | — | Chuyền baton | rule_32 |
| 概要 | がいよう | KHÁI YẾU | Tổng quan | rule_32 |
| アーキテクチャ | アーキテクチャ | — | Architecture | rule_32 |
| 受け継ぎ | うけつぎ | THỤ KẾ | Tiếp nhận | rule_32 |
| 録画 | ろくが | LỤC HỌA | Quay video | rule_33 |
| 許可 | きょか | HỨA KHẢ | Cho phép | rule_33 |
| 編集 | へんしゅう | BIÊN TẬP | Biên tập / edit | rule_33 |
| 限定 | げんてい | HẠN ĐỊNH | Giới hạn | rule_33 |
| 機密 | きみつ | CƠ MẬT | Bảo mật / confidential | rule_33 |
| 同意 | どうい | ĐỒNG Ý | Đồng ý | rule_33 |
| 失効 | しっこう | THẤT HIỆU | Hết hiệu lực / expire | rule_33 |
| 自己評価 | じこひょうか | TỰ KỶ BÌNH GIÁ | Tự đánh giá | rule_34 |
| ルーブリック | ルーブリック | — | Bảng tiêu chí | rule_34 |
| 強み | つよみ | CƯỜNG | Điểm mạnh | rule_34 |
| 改善点 | かいぜんてん | CẢI THIỆN ĐIỂM | Điểm cần cải thiện | rule_34 |
| 暗唱 | あんしょう | ÁM XƯỚNG | Học thuộc | rule_34 |
| 反射 | はんしゃ | PHẢN XẠ | Phản xạ | rule_34 |
| 投資 | とうし | ĐẦU TƯ | Đầu tư | rule_34 |
| 改善サイクル | かいぜんサイクル | CẢI THIỆN | Chu kỳ cải thiện | rule_35 |
| リハーサル | リハーサル | — | Tập dượt | rule_35 |
| パイロット | パイロット | — | Chạy thử | rule_35 |
| レトロ | レトロ | — | Nhìn lại | rule_35 |
| 比較 | ひかく | TỈ GIẢO | So sánh | rule_35 |
| 目標 | もくひょう | MỤC TIÊU | Mục tiêu | rule_35 |
...
| Mục | Nội dung |
|-----|----------|
| Tên sách | Hizashi — Thuyết trình / プレゼンテーション |
