...
# Rule 29 — Khi gặp deadlock / 行き詰まった場合
...
>
> 🇻🇳 *Đây là draft agenda buổi họp định kỳ tháng 〇 ạ.*
>
> 📝 _アジェンダ提出の標準フレーズ_
...
>
> 🇻🇳 *Em đã đặt 〇〇 và xong cả checklist thiết bị ạ.*
>
> 📝 _予約と設備確認を分けて報告_
...
>
> 🇻🇳 *Đã phát link mới, hạn đến 〇〇. Audio và share screen test OK.*
>
> 📝 _オンライン会議の事前報告_
...
> 🇯🇵 「録画は冒頭でご確認しよう。」
>
> 🇻🇳 *Recording đầu họp mình xin phép nhé.*
>
> 📝 _録画許可確認のリマインド_
...
>
> 🇻🇳 *Em là 〇〇 bên 〇〇, em xin phép làm chủ trì buổi họp hôm nay ạ.*
>
> 📝 _司会自己紹介の定型句_
...
>
> 🇻🇳 *Agenda hôm nay gồm 〇 mục ạ. Tổng thời lượng là 〇〇 phút ạ.*
>
> 📝 _アジェンダ全体像の宣言_
...
>
> 🇻🇳 *Người chủ trì là 〇〇 ạ. 〇〇 phụ trách người ghi biên bản, biên bản em sẽ chia sẻ draft trong hôm nay ạ.*
>
> 📝 _役割公表の定型句_
...
>
> 🇻🇳 *Đưa được vào biên bản dưới dạng quyết định — đó là goal hôm nay ạ.*
>
> 📝 _ゴール粒度の定義_
...
### Rule 33 — Online meeting mute/unmute etiquette / オンライン会議のマナー（mute/unmute）
...
### Rule 34 — Hybrid meeting cân bằng online/offline / ハイブリッド会議の運営

**ズン (em Dũng):**

> 🇯🇵 「まずオンラインでご参加の〇〇様、ご意見をお聞かせいただけますでしょうか？」
>
> 🇻🇳 *Trước tiên xin được nghe ý kiến của anh/chị 〇〇 online ạ.*
>
...
>
> 🇻🇳 *Em xin được share màn hình 〇〇 ạ.*
>
> 📝 _画面共有の予告フレーズ_
...
### Rule 37 — Crisis meeting họp gấp / 緊急会議の運営（Fact-Impact-Action-Owner）
...
>
> 🇻🇳 *Em xin báo cáo theo thứ tự Fact → Impact → Action → Owner ạ.*
>
> 📝 _緊急会議の構成宣言_


### Rule 38 — Postpone/cancel họp last-minute / 直前のリスケジュール
...
>
> 🇻🇳 *Brainstorming hôm nay em xin confirm 4 nguyên tắc: (1) không phê bình, (2) coi trọng số lượng, (3) build-on welcome, (4) time-box.*
>
> 📝 _ブレスト4原則宣言フレーズ_
...
> 🇯🇵 「〇〇に便乗で、〜というのは？」
>
> 🇻🇳 *Build-on ý 〇〇, 〜 thì sao?*
>
> 📝 _build-on フレーズ_


### Rule 41 — Performance review feedback / フィードバック面談（GROW モデル）

**フオン副部長 (chị Hương):**

> 🇯🇵 「【Reality】〇〇という事実がありました。」
>
> 🇻🇳 *[Reality] Có sự thực là 〇〇.*
>
> 📝 _事実ベースのフィードバック_
...
>
> 🇻🇳 *[Options] Có hướng 〜. Em thấy hướng nào hợp?*
>
> 📝 _本人に選ばせる options 提示_
...
>
> 🇻🇳 *Topic còn lại em xin bàn ở buổi riêng ạ. Anh/chị dành 〇 phút lúc 〇h ngày 〇/〇 được không ạ?*
>
> 📝 _積み残し+次回スロット提案_
...
>
> 🇻🇳 *〇〇 — anh/chị 〇〇, deadline 〇/〇. OK không ạ?*
>
> 📝 _Who/What/When+confirmフレーズ_
...
>
> 🇻🇳 *Nếu có câu hỏi/cần sửa, phiền anh/chị reply trước 〇h ngày 〇/〇 ạ.*
>
> 📝 _review 期限フレーズ_


### Rule 46 — Format biên bản chuẩn (extended) / 議事録の標準フォーマット（extended版）

**ズン (em Dũng):**

> 🇯🇵 「extended フォーマット8要素で議事録を作成いたします。」
>
> 🇻🇳 *Em sẽ làm biên bản theo format extended 8 element ạ.*
>
> 📝 _重要会議の議事録作成宣言_


### Rule 47 — Follow-up email cảm ơn / 会議後のお礼メール
...
>
> 📝 _欠席を formal に ack するフレーズ_

**ズン (em Dũng):**

> 🇯🇵 「15分ほどお時間頂戴し、catch-up させていただけませんでしょうか？」
>
> 🇻🇳 *Em xin anh/chị 15 phút để catch-up có được không ạ?*
>
> 📝 _欠席者への catch-up 提案_


### Rule 49 — Tracking decisions trong CRM / 決定事項の社内管理（CRM/Notion）

**ズン (em Dũng):**

> 🇯🇵 「Notion の『決定事項一覧』に記録があります。」
>
> 🇻🇳 *Có record trong Notion 'Decisions list' ạ.*
>
> 📝 _single source of truth を案内するフレーズ_


### Rule 50 — Self-reflection cải tiến / 振り返りと改善（10項目チェックリスト）

**ズン (em Dũng):**

> 🇯🇵 「10項目チェックリストで今週の会議を振り返ります。」
>
> 🇻🇳 *Em reflect các buổi họp tuần này bằng checklist 10 items.*
>
> 📝 _self-reflection 開始フレーズ_
...
| 議題 | ぎだい | Chủ đề bàn / agenda item | rule_01 |
| アジェンダ | agenda | Agenda | rule_01 |
| 出席者 | しゅっせきしゃ | Người tham dự | rule_01 |
| 所要時間 | しょようじかん | Thời lượng cần | rule_01 |
| アウトプット | autoputto | Output / kết quả mong đợi | rule_01 |
| 旨 | むね | Ý là... / nội dung | rule_01 |
| 月例 | げつれい | Định kỳ tháng | rule_01 |
| 案 | あん | Đề xuất / draft | rule_01 |
| 招待メール | しょうたいメール | Email mời | rule_02 |
| ご案内申し上げます | ごあんないもうしあげます | Xin trân trọng thông báo | rule_02 |
| 出欠 | しゅっけつ | Tham dự / vắng | rule_02 |
| 返信期限 | へんしんきげん | Deadline reply | rule_02 |
| 〜までに | までに | Trước thời điểm... | rule_02 |
| 開催 | かいさい | Tổ chức (họp/sự kiện) | rule_02 |
| 会議室 | かいぎしつ | Phòng họp | rule_03 |
| 予約 | よやく | Đặt trước | rule_03 |
| 設備 | せつび | Trang thiết bị | rule_03 |
| プロジェクター | purojekutaa | Projector | rule_03 |
| ネームプレート | name plate | Bảng tên / chỗ ngồi | rule_03 |
| 人数分 | にんずうぶん | Đủ số người | rule_03 |
| 押さえる | おさえる | Giữ chỗ / book | rule_03 |
| 備品 | びひん | Đồ dùng văn phòng | rule_03 |
| オンライン会議 | online kaigi | Họp online | rule_04 |
| リンク | link | Link (URL) | rule_04 |
| 画面共有 | がめんきょうゆう | Share màn hình | rule_04 |
| 録画 | ろくが | Ghi hình / record | rule_04 |
| 音声 | おんせい | Âm thanh | rule_04 |
| 背景 | はいけい | Background | rule_04 |
| 待機室 | たいきしつ | Waiting room | rule_04 |
| 有効期限 | ゆうこうきげん | Hạn dùng | rule_04 |
| 資料 | しりょう | Tài liệu | rule_05 |
| 事前配布 | じぜんはいふ | Phát trước | rule_05 |
| 一読 | いちどく | Đọc qua một lượt | rule_05 |
| バージョン / 版 | baajon / はん | Version | rule_05 |
| 差分 | さぶん | Diff / phần thay đổi | rule_05 |
| ハイライト | hairaito | Highlight | rule_05 |
| 修正版 | しゅうせいばん | Bản chỉnh sửa | rule_05 |
| 最新化 | さいしんか | Cập nhật mới nhất | rule_05 |
| 5分前行動 | ごふんまえこうどう | "Quy tắc 5 phút trước" | rule_06 |
| 定刻 | ていこく | Đúng giờ (giờ định) | rule_06 |
...
| 即答 | そくとう | Trả lời ngay | rule_07 |
| 現実的 | げんじつてき | Thực tế / realistic | rule_07 |
| 譲れない | ゆずれない | Không nhượng được | rule_07 |
| コミット | komitto | Commit / cam kết | rule_07 |
| 想定問答集 | そうていもんどうしゅう | Q&A dự đoán | rule_08 |
| 想定質問 | そうていしつもん | Câu hỏi dự đoán | rule_08 |
| 〜済み | ずみ | Đã xong | rule_08 |
| 値引き | ねびき | Giảm giá | rule_08 |
| 方針 | ほうしん | Phương châm | rule_08 |
| 見直し | みなおし | Xem xét lại | rule_08 |
| エスカレーション | escalation | Escalation | rule_08 |
| 顕在化 | けんざいか | Hiện ra (risk → thực tế) | rule_08 |
...
| 漢字 / Tiếng Nhật | Cách đọc (Romaji) | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|
| 第一声 | だいいっせい | Câu mở đầu | rule_09 |
| 司会 | しかい | Chủ trì / MC | rule_09 |
| 務める | つとめる | Đảm nhận | rule_09 |
| 早速 | さっそく | Ngay lập tức | rule_09 |
| 誠に | まことに | Thật sự (formal) | rule_09 |
| お集まりいただく | おあつまりいただく | (Quý vị) đã đến tham dự | rule_09 |
| 〜に沿って | にそって | Theo (kế hoạch / agenda) | rule_09 |
| 自己紹介 | じこしょうかい | Tự giới thiệu | rule_10 |
| 〜と申します | ともうします | "Tôi tên là..." (khiêm nhường) | rule_10 |
| 担当する | たんとうする | Phụ trách | rule_10 |
| および | および | Và (formal) | rule_10 |
| 不慣れ | ふなれ | Chưa quen | rule_10 |
| 役割 | やくわり | Vai trò | rule_10 |
| 経験を活かす | けいけんをいかす | Tận dụng kinh nghiệm | rule_10 |
| 名刺 | めいし | Danh thiếp | rule_11 |
| 名刺交換 | めいしこうかん | Trao danh thiếp | rule_11 |
| 頂戴いたします | ちょうだいいたします | Em xin nhận ạ (lúc nhận card) | rule_11 |
| 両手 | りょうて | Hai tay | rule_11 |
| 席順 | せきじゅん | Thứ tự chỗ ngồi | rule_11 |
| 卓上 | たくじょう | Trên bàn | rule_11 |
| 折り曲げる | おりまげる | Gập / nhăn | rule_11 |
| 書き込み | かきこみ | Viết note vào | rule_11 |
| 弊社 | へいしゃ | Công ty (chúng) tôi (humble) | rule_12 |
| 〇〇株式会社様 | かぶしきがいしゃさま | Cty 〇〇 (kính ngữ) | rule_12 |
| 役職 | やくしょく | Chức vụ | rule_12 |
| 続きまして | つづきまして | "Tiếp đến..." | rule_12 |
| 〜より | より | Phía / từ phía... | rule_12 |
| まずは | まずは | "Đầu tiên là..." | rule_12 |
| 〇点 | てん | 〇 mục (đếm cho議題) | rule_13 |
...
| ドラフト | doraft | Bản nháp | rule_14 |
| 決定事項 | けっていじこう | Mục đã quyết | rule_14 |
| 共有 | きょうゆう | Chia sẻ | rule_14 |
| ゴール | gooru | Mục tiêu / goal | rule_15 |
| 合意 | ごうい | Thống nhất / agree | rule_15 |
| 決定 | けってい | Quyết định | rule_15 |
| 粒度 | りゅうど | Granularity / mức chi tiết | rule_15 |
| 〜状態 | じょうたい | Trạng thái | rule_15 |
| 持っていく | もっていく | Đưa tới | rule_15 |
| 時間配分 | じかんはいぶん | Phân bổ thời gian | rule_16 |
| 開始 | かいし | Bắt đầu | rule_16 |
| 終了 | しゅうりょう | Kết thúc | rule_16 |
| 延長 | えんちょう | Kéo dài | rule_16 |
| 押す | おす | (時間が押す) Trễ giờ | rule_16 |
| 可否 | かひ | Có / không | rule_16 |
| 〜途中 | とちゅう | Giữa chừng | rule_16 |
| 相談 | そうだん | Tham vấn / xin phép | rule_16 |
| 入室 | にゅうしつ | Vào phòng | rule_17 |
| 失礼いたします | しつれいいたします | "Em xin phép..." (formal) | rule_17 |
| 遅れる | おくれる | Trễ | rule_17 |
| 申し訳ございません | もうしわけございません | Em vô cùng xin lỗi | rule_17 |
| 着席 | ちゃくせき | Ngồi xuống | rule_17 |
| 追いつく | おいつく | Bắt kịp | rule_17 |
| お続けください | おつづけください | Mời anh/chị tiếp tục | rule_17 |
| 欠席 | けっせき | Vắng mặt | rule_18 |
| 体調不良 | たいちょうふりょう | Không khỏe (lý do generic) | rule_18 |
| 決裁 | けっさい | Phê duyệt / authorize | rule_18 |
| 権限 | けんげん | Thẩm quyền | rule_18 |
| 方向性 | ほうこうせい | Định hướng | rule_18 |
| 最終確定 | さいしゅうかくてい | Chốt cuối | rule_18 |
...
| 一点 | いってん | Một điểm | rule_19 |
| 挙手 | きょしゅ | Giơ tay | rule_19 |
| 発言 | はつげん | Phát biểu | rule_19 |
| 割り込み | わりこみ | Cắt ngang | rule_19 |
| 確認させていただく | かくにんさせていただく | Xin được xác nhận | rule_19 |
| 順番に | じゅんばんに | Theo thứ tự | rule_20 |
| お伺いする | おうかがいする | Xin được hỏi (kenjō) | rule_20 |
| 主担当 | しゅたんとう | Người phụ trách chính | rule_20 |
| リリース予定日 | リリースよていび | Ngày dự kiến release | rule_20 |
| デプロイ | depuroi | Deploy | rule_20 |
| 不明点 | ふめいてん | Điểm không rõ | rule_21 |
| 認識 | にんしき | Nhận thức / cách hiểu | rule_21 |
| 階層 | かいそう | Phân cấp | rule_21 |
| 職務 | しょくむ | Chức trách / nhiệm vụ | rule_21 |
| 手戻り | てもどり | Phải làm lại / rework | rule_21 |
| 同意 | どうい | Đồng ý | rule_22 |
| 概ね | おおむね | Đại thể / phần lớn | rule_22 |
| 内訳 | うちわけ | Chi tiết phân tách | rule_22 |
| フィージビリティ | fiijibiriti | Feasibility | rule_22 |
| 改めて | あらためて | Lại / cẩn thận một lần nữa | rule_22 |
| 異論 | いろん | Ý kiến trái chiều | rule_23 |
| 観点 | かんてん | Góc nhìn | rule_23 |
| 工数 | こうすう | Man-hour / công sức | rule_23 |
| 品質保証 | ひんしつほしょう | QA / đảm bảo chất lượng | rule_23 |
| 優先度 | ゆうせんど | Mức độ ưu tiên | rule_23 |
| 削減 | さくげん | Cắt giảm | rule_23 |
| 理にかなう | りにかなう | Hợp lý | rule_23 |
| 要約 | ようやく | Tóm tắt | rule_24 |
| 決済ゲートウェイ | けっさいゲートウェイ | Cổng thanh toán | rule_24 |
| 返金 | へんきん | Hoàn tiền | rule_24 |
| ワークフロー | ワークフロー | Workflow | rule_24 |
| 後回し | あとまわし | Để lại sau | rule_24 |
| 最優先 | さいゆうせん | Ưu tiên cao nhất | rule_24 |
| 持ち帰る | もちかえる | Mang về (xem xét) | rule_25 |
| 検討 | けんとう | Xem xét / cân nhắc | rule_25 |
| 社内 | しゃない | Trong công ty | rule_25 |
| 上長 | じょうちょう | Cấp trên | rule_25 |
| 稟議 | りんぎ | Quy trình duyệt nội bộ JP | rule_25 |
| 即決 | そっけつ | Quyết ngay | rule_25 |
| 提案 | ていあん | Đề xuất | rule_26 |
| 構成 | こうせい | Cấu trúc / phối hợp | rule_26 |
| バックログ | bakkurogu | Backlog | rule_26 |
| スプリント | supurinto | Sprint | rule_26 |
| 拡張機能 | かくちょうきのう | Extension feature | rule_26 |
| 頂戴する | ちょうだいする | Xin nhận (kenjō) | rule_26 |
| 根拠 | こんきょ | Căn cứ | rule_27 |
| 反論 | はんろん | Phản biện | rule_27 |
| 実績 | じっせき | Thực tích / kết quả thực tế | rule_27 |
| 換算 | かんさん | Quy đổi | rule_27 |
| 結合試験 | けつごうしけん | Integration test | rule_27 |
| 増員 | ぞういん | Tăng người | rule_27 |
| 見積もり | みつもり | Báo giá / ước lượng | rule_27 |
| キャパシティ | kyapashitii | Capacity | rule_28 |
| ピーク時間帯 | ピークじかんたい | Khung giờ peak | rule_28 |
| DAU/MAU | DAU/MAU | Daily/Monthly Active User | rule_28 |
| 想定 | そうてい | Giả định | rule_28 |
| 成長率 | せいちょうりつ | Tỷ lệ tăng trưởng | rule_28 |
| 月次 | げつじ | Hàng tháng | rule_28 |
| 行き詰まる | いきづまる | Bế tắc | rule_29 |
| 冷却期間 | れいきゃくきかん | Thời gian cool-off | rule_29 |
| 折り合う | おりあう | Tìm điểm dung hoà | rule_29 |
| 限界 | げんかい | Giới hạn | rule_29 |
...
| クラウド選定 | クラウドせんてい | Lựa chọn cloud | rule_32 |
| 比較表 | ひかくひょう | Bảng so sánh | rule_32 |
| 試算 | しさん | Tính thử / estimate | rule_32 |
| インフラ | infura | Hạ tầng | rule_32 |
| 添付 | てんぷ | Đính kèm | rule_32 |
...
| 漢字 / Tiếng Nhật | Cách đọc (Romaji) | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|
| ミュート | myūto | Mute | rule_33 |
| ミュート解除 | ミュートかいじょ | Unmute | rule_33 |
| カメラオン/オフ | kamera on/off | Camera on/off | rule_33 |
| 挙手機能 | きょしゅきのう | Raise-hand function | rule_33 |
| 遅延 | ちえん | Delay | rule_33 |
| 既定 | きてい | Mặc định | rule_33 |
| ハイブリッド | haiburiddo | Hybrid | rule_34 |
| マイク | maiku | Mic | rule_34 |
| 確認 | かくにん | Xác nhận | rule_34 |
...
| 緊急会議 | きんきゅうかいぎ | Họp khẩn | rule_37 |
| 簡潔 | かんけつ | Ngắn gọn / súc tích | rule_37 |
| 影響範囲 | えいきょうはんい | Phạm vi ảnh hưởng | rule_37 |
| 復旧 | ふっきゅう | Khôi phục | rule_37 |
...
| 便乗 | びんじょう | Đi theo / build on | rule_40 |
| タイムボックス | taimubokkusu | Time-box | rule_40 |
| 解約 | かいやく | Hủy hợp đồng | rule_40 |
| 投票 | とうひょう | Bỏ phiếu | rule_40 |
| 振り返り | ふりかえり | Nhìn lại / review | rule_41 |
| 完遂 | かんすい | Hoàn thành trọn vẹn | rule_41 |
| 楽観的 | らっかんてき | Lạc quan | rule_41 |
| 逼迫 | ひっぱく | Bị ép / căng | rule_41 |
| 即効性 | そっこうせい | Hiệu quả nhanh | rule_41 |
| 時間切れ | じかんぎれ | Hết giờ | rule_42 |
| 積み残し | つみのこし | Còn lại / chưa xong | rule_42 |
| 詳細 | しょうさい | Chi tiết | rule_42 |
...
| 貴重 | きちょう | Quý báu | rule_47 |
| 印象に残る | いんしょうにのこる | Để lại ấn tượng | rule_47 |
| 結語 | けつご | Câu kết | rule_47 |
| 欠席者 | けっせきしゃ | Người vắng | rule_48 |
| ご都合つかず | ごつごうつかず | Không tiện lịch | rule_48 |
| お出まし | おでまし | Tham dự (formal) | rule_48 |
| 経理視点 | けいりしてん | Góc nhìn kế toán | rule_48 |
| catch-up | catch-up | Bù lại | rule_48 |
| 社内管理 | しゃないかんり | Quản lý nội bộ | rule_49 |
| 一覧 | いちらん | Danh sách / list | rule_49 |
| 記録 | きろく | Ghi chép / record | rule_49 |
| 追跡 | ついせき | Track / theo dõi | rule_49 |
...
- A) 突然共有して説明開始
- **B) 予告→2-3秒待機→「ご覧いただけますでしょうか」確認→説明→終了宣言**
- C) 共有して、終わったら自然消滅
- D) メールで送る方がいい
...
- 🇻🇳 5 phút trước là 'on-time' theo Nhật. 30 phút quá sớm gây phiền, đúng giờ thì thành trễ.
...
- A) 進捗報告10分、課題15分です。
- **B) 議題1: 進捗報告 15:00〜15:10、議題2: 課題対応 15:10〜15:25。**
- C) ざっくり1時間です。
- D) 時間は適当でいきます。
...
- A) 大きな声で何度も謝罪し、議題を確認する。
- **B) 「失礼いたします、遅れて申し訳ございません」と一言述べ、静かに着席して資料に追いつく。**
- C) 黙って入って何も言わずに座る。
...
- A) すぐに割り込んで質問する
- **B) 発言が一区切りしたところで「恐れ入りますが、一点よろしいでしょうか？」と挙手する**
- C) メモに書いて隣の人に渡す
- D) 会議後に個別に質問する
...
- A) とりあえず「承知しました」と返事し、後で同僚に聞く
- B) 「全部分かりません」と正直に言う
- **C) 「〇〇という点をもう一度ご説明いただけますでしょうか」と該当箇所を絞って質問する**
- D) 黙って頷いてやり過ごす
...
- A) 「どうしましょうか？」と参加者に丸投げ
- **B) 「議論を踏まえA案が現実的かと存じます。A案で進める方向でよろしいでしょうか？異論があればお聞かせください」と提示・確認**
- C) 強引に多数決を採る
- D) 次回に持ち越す
...
- A) また今度
- B) 後で連絡します
- **C) 本件は持ち帰り、〇月〇日〇時までにメールにてご回答いたします**
- D) ちょっと厳しいです
...
- A) ミュートを解除し、カメラはオフのまま即座に話す
- B) ミュートのまま割り込んで話す
- **C) 挙手機能で発言を求め、許可後にカメラオン+ミュート解除+名乗りで発言開始**
- D) チャットで全部済ませる
...
- A) 黙って続きから話す
- B) 「あ、戻りました」と一言で再開
- **C) 「接続が不安定で時間を頂戴しました。どこまで見えていましたか？」と謝罪+last seen確認**
- D) 会議を終了する
...
- A) 雑談中心で関係を作る
- **B) 進捗・課題・相談・次のステップの4部構成で具体的に報告する**
- C) 課題だけを延々と話す
- D) 上司に質問されるまで何も話さない
...
- A) 「もう少し続けましょうか」と聞く
- **B) 「お時間が来ましたので、本日はここまで。決定済みは〇、積み残しは〇月〇日に」と3ステップで締める**
- C) 勝手に延長する
- D) 全議題終わるまで強行
...
- A) じゃあ、お疲れ様でした
- **B) 本日はお時間いただき誠にありがとうございました。今後ともどうぞよろしくお願い申し上げます**
- C) 終わりました
- D) また今度
...
### J3.27 (từ rule_44 — Confirm action items + owner)
...
- A) 1週間以内、口頭で
- **B) 24時間以内、6項目（日時/出席者/議題/決定/TODO/次回）+review期限つきメール**
- C) 次回会議で口頭共有
- D) 送らない
...
- A) 議事録のみ送付
- B) お礼メールのみ送付
- **C) 議事録（formal record）+お礼メール（関係構築）の両方を24時間以内に送付**
- D) 次回会議まで何も送らない
...
- A) 議事録だけ転送
- **B) 個別メールで ack +関連項目に絞った意見聴取+15分 catch-up 提案**
- C) 次回会議で口頭共有
- D) 何もしない
...
- A) 議事録メールに任せる
- **B) Notion/CRMに decision/source/owner/status の4フィールドで48時間以内に記録**
- C) 口頭で伝える
- D) 個人メモ
...
- A) 毎月の人事評価のみ
- **B) 週末15分、10項目チェックリストで振り返り、1〜2点を翌週に改善**
- C) 上司に毎日聞く
- D) 何もしない
...
- A) 会議の議事録を作るため
- **B) 客の前で社内意見が割れないよう、役割分担と red line を統一するため**
- C) 出席者に弁当を配るため
- D) 会議室の予約を確認するため
...
- A) 黙って通常通り会議を進め、その場で全て決定する。
- **B) 冒頭で欠席を公表し、本日は『方向性合意』までとして最終確定は後日に回す。**
- C) 会議をその場で中止して延期する。
- D) 欠席者の代わりに司会が決裁してしまう。
...
- A) はい、大丈夫です
- **B) 方向性につきましては概ね同意でございます。詳細は別途確認させてください**
- C) ちょっと無理かもしれません
- D) 全くおっしゃるとおりです
...
- A) とりあえず「OKです」と返事しておく
- B) 「無理です」と即時拒否する
- **C) 「持ち帰って検討させてください。〇日までに回答します」と期限つきで保留する**
- D) 黙って答えない
...
- A) それは違うと思います
- **B) ご実績、参考になります。ただ弊社のPhase 1データでは平均10.5週間を要しております**
- C) うちはインドと違いますから
- D) ちょっと無理かもしれません
...
- A) 「では延期します」と即答する
- B) 「どういう意味ですか？」と open-ended に聞く
- **C) 「延期のご検討中ですか？それとも支援が必要でしょうか？」と二択で確認する**
- D) 「分かりました」と何もせず流す
...
- A) オフライン側を優先して進行する
- **B) オンライン参加者に最初に発言機会を与え、オフラインの議論は要約して共有する**
- C) 全員に同時発言を許す
- D) チャットだけで進める
...
- A) 「急用で無理になりました、また連絡します」
- **B) 「直前で恐縮ですが、CTOが緊急会議のため。代替日として明日10時、明後日11時、来週月曜14時いずれかご都合いかがでしょうか。資料は本日中にお送りします」**
- C) メールだけで「キャンセル」と一言
- D) 連絡せず欠席する
...
- A) 「君は〜すぎる」と性格を指摘
- **B) Goal（成果）→ Reality（事実）→ Options（選択肢）→ Will（コミット）の構造で会話**
- C) 感情的に怒る
- D) 曖昧に「次から気をつけて」とだけ言う
...
- A) 出席者と内容のみ
- **B) 件名・概要・目的・議題・要旨・決定事項・TODO（owner+deadline）・次回 の8要素+未決事項追跡**
- C) メモ書きのみ
- D) 決定事項とTODOを混在させる
...
────────────────────────────
 D. Kết thúc (Closing)
────────────────────────────
  □ 9. Confirm action items với Who/What/When?
