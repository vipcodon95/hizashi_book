# Bảng thuật ngữ — Sách 03: Meeting

> Các viết tắt chuyên ngành dùng trong sách. Tra theo bảng chữ cái.

| Viết tắt | Dạng đầy đủ | Nghĩa tiếng Việt |
|----------|-------------|------------------|
| AWS | Amazon Web Services | Nền tảng điện toán đám mây của Amazon (dùng trong ngữ cảnh chọn cloud: AWS vs. Azure) |
| BD | Business Development | Phát triển kinh doanh (chức danh nhân vật Dũng) |
| BJT | Business Japanese Test | Kỳ thi tiếng Nhật thương mại (J5→J2); mục tiêu luyện thi xuyên suốt sách |
| CC | Carbon Copy | Gửi thêm bản sao email (trường CC trong mail mời họp) |
| CFO | Chief Financial Officer | Giám đốc tài chính (chức danh nhân vật anh Loan / nhân vật phụ) |
| CRM | Customer Relationship Management | Hệ thống quản lý quan hệ khách hàng / lưu trữ quyết định nội bộ (rule 49) |
| CTO | Chief Technology Officer | Giám đốc kỹ thuật (chức danh nhân vật anh Hà) |
| DAU | Daily Active Users | Số người dùng hoạt động mỗi ngày (dữ liệu kỹ thuật cần xin trong rule 28) |
...
| MAU | Monthly Active Users | Số người dùng hoạt động mỗi tháng (dữ liệu kỹ thuật cần xin trong rule 28) |
| MC | Master of Ceremonies | Người chủ trì / điều phối cuộc họp (= 司会 shikai) |
| PDF | Portable Document Format | Định dạng file tài liệu; bắt buộc dùng khi gửi tài liệu trước họp (rule 05) |
| PM | Project Manager | Quản lý dự án (chức danh nhân vật anh Matsumoto — phía khách Nhật) |
