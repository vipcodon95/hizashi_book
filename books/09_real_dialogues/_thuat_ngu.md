# Bảng thuật ngữ — Sách 09: Real Dialogues
...
| ANA | All Nippon Airways | Hãng hàng không All Nippon Airways (Nhật Bản) |
| API | Application Programming Interface | Giao diện lập trình ứng dụng |
| ATM | Automated Teller Machine | Máy rút tiền tự động |
| AWS | Amazon Web Services | Dịch vụ điện toán đám mây của Amazon |
| BCP | Business Continuity Plan | Kế hoạch duy trì hoạt động kinh doanh khi có sự cố |
| BD | Business Development | Phát triển kinh doanh (chức danh / bộ phận) |
| CFO | Chief Financial Officer | Giám đốc tài chính |
| COBOL | Common Business-Oriented Language | Ngôn ngữ lập trình hướng nghiệp vụ (legacy) |
...
| SMBC | Sumitomo Mitsui Banking Corporation | Ngân hàng Sumitomo Mitsui (Nhật Bản) |
| SOC | System and Organization Controls | Tiêu chuẩn kiểm toán bảo mật hệ thống (vd SOC 2 Type 2) |
| SQS | Amazon Simple Queue Service | Dịch vụ hàng đợi tin nhắn của AWS |
| TED | TED (Technology, Entertainment, Design) | Chuỗi hội thảo / video diễn thuyết TED Talks |
| USB | Universal Serial Bus | Cổng kết nối thiết bị phổ biến |
