# Bảng thuật ngữ — Sách 21: Đại Đại học Năm 1
...
| BCNF | Boyce–Codd Normal Form | Dạng chuẩn Boyce–Codd trong thiết kế CSDL quan hệ |
| BFS | Breadth-First Search | Thuật toán duyệt đồ thị theo chiều rộng (dùng hàng đợi) |
| BST | Binary Search Tree | Cây tìm kiếm nhị phân |
| CBT | Computer-Based Testing | Hình thức thi trên máy tính (FE từ 4/2023) |
...
| HTML | HyperText Markup Language | Ngôn ngữ đánh dấu siêu văn bản, nền tảng trang web |
| HTTP | HyperText Transfer Protocol | Giao thức truyền tải siêu văn bản |
| IPA | Information-technology Promotion Agency | Cơ quan xúc tiến công nghệ thông tin Nhật Bản, đơn vị cấp chứng chỉ FE/AP |
...
| NF | Normal Form (1NF / 2NF / 3NF) | Các dạng chuẩn hoá trong thiết kế cơ sở dữ liệu quan hệ |
| OJ | Online Judge | Hệ thống chấm bài lập trình tự động trực tuyến (vd AtCoder, LeetCode) |
...
| WBS | Work Breakdown Structure | Cấu trúc phân rã công việc trong quản lý dự án |
