...
| **V** | Hộp thư thoại, Trực tuyến & Thực hành tốt nhất | 留守電・オンライン・ベストプラクティス | 12 |
...
Sách 02 dùng cùng tuyến nhân vật với sách 01 (Email), bổ sung thêm 3 vai cho điện thoại:

### Công ty Thiên Phát / ティエンファット社 (TP.HCM, gia công phần mềm)

| Tên VN | 名前 (JP) | Vai | Tính cách |
|--------|----------|-----|-----------|
| **em Dũng** | **ズン** | Phụ trách kinh doanh | Trẻ, chu đáo, đang luyện BJT — nhân vật chính |
| **chị Hương** | **フオン副部長** | Phó phòng | Cứng rắn, dìu dắt Dũng |
| **anh Tuấn** | **トゥアンリーダー** | Trưởng nhóm | Vui tính, hay giải thích văn hóa Nhật |
| **chị Loan** | **ロアン経理部長** | Trưởng phòng kế toán | Chính xác, kỹ tính |
| **em Linh** | **リン** | Trợ lý | Mới vào, hay hỏi |
| **em Hải** | **ハイ** | Lập trình viên kiêm vận hành | Bốc máy → chuyển máy nhiều |
| **anh Hà** | **ハー** | Giám đốc công nghệ | Quản lý, hay vắng |
...
| お世話になっております | おせわになっております | THẾ THOẠI | Cảm ơn anh đã hỗ trợ (chào trang trọng) |
...
# Rule 05 — Khung mẫu 5W1H ghi chú / 5W1Hメモテンプレート
...
| 対応 | たいおう | ĐỐI ỨNG | Cách xử lý, đáp |


# Rule 06 — Cao độ và tốc độ giọng qua điện thoại / 電話の声の高さ・速度
...
| 容赦 | ようしゃ | DUNG XÁ | Tha thứ, thông cảm |
...
# Rule 20 — Bước đầu xử lý phàn nàn qua điện thoại / クレーム電話の最初の対応
...
| 左様でございますか | さようでございますか | TẢ DẠNG | Vâng, em hiểu rồi (kính ngữ) |
...
# Rule 28 — Trình bày 30 giây — truyền đạt mục đích gọn / 30秒で要件を伝える
...
| 国際電話 | こくさいでんわ | QUỐC TẾ ĐIỆN THOẠI | Cuộc gọi quốc tế |
...
# Rule 49 — Hộp thư thoại 30 giây công thức / 留守番電話に残すメッセージ
...
# Rule 53 — Giọng điệu khi chia sẻ màn hình / 画面共有時の声の使い方
...
| 小休止 | しょうきゅうし | TIỂU HƯU CHỈ | Nghỉ ngắn |
...
*Tổng hợp các cụm câu mẫu từ tất cả 60 rule, sắp xếp theo phần để tiện tra cứu khi soạn câu hoặc luyện tập.*
...
### Rule 05 — Mẫu ghi chú 5W1H / 5W1Hメモテンプレート
...
### Rule 06 — Cao độ và tốc độ giọng điện thoại / 電話の声の高さ・速度

**ズン (em Dũng):**

>  「電話の声は半音上げて、10%遅く話す。」
>
>  *Giọng điện thoại: cao hơn nửa cung, chậm hơn 10%.*
>
>  _電話声の3調整原則を覚える_
...
### Rule 26 — Khuôn giới thiệu khi gọi đi / 発信時の名乗りフォーマット
...
### Rule 28 — Trình bày mục đích 30 giây — gọn súc tích / 30秒で要件を伝える
...
### Rule 42 — Cách từ chối qua điện thoại không gây xước / 電話で断る言い方
...
## Phần V — Hộp thư thoại, Họp trực tuyến & Kỹ năng then chốt

### Rule 49 — Khuôn hộp thư thoại 30 giây / 留守番電話に残すメッセージ
...
### Rule 52 — Nghi thức họp trực tuyến qua Zoom / Teams / オンライン会議の電話作法
...
### Rule 57 — Giành lượt phát biểu trong họp trực tuyến — xen lời khéo léo / 電話会議で発言を取る
...
>
>  *Phía trực tuyến cho em xin ý kiến với ạ.*
>
...
*Tổng hợp tất cả từ vựng liên quan điện thoại từ 60 rules. Sắp xếp theo Phần.*

*Hiragana và nghĩa Việt giúp người Việt học JP business dễ tra cứu.*
...
|------|------|------|------|------|
| お電話 | おでんわ | — ĐIỆN THOẠI | Cuộc gọi (kính ngữ) | rule_01 |
| ありがとうございます | ありがとうございます | — | Cảm ơn (kính ngữ) | rule_01 |
| 営業部 | えいぎょうぶ | DOANH NGHIỆP BỘ | Phòng kinh doanh | rule_01 |
| でございます | でございます | — | です (kính ngữ trang trọng nhất) | rule_01 |
| 申します | もうします | — | (Khiêm nhường) "tôi tên là…" | rule_01 |
| お世話になっております | おせわになっております | — | Cảm ơn anh đã hỗ trợ (chào trang trọng) | rule_01 |
| コール | コール | — | Hồi chuông | rule_02 |
| 大変 | たいへん | ĐẠI BIẾN | Rất, hết sức | rule_02 |
| 席を外す | せきをはずす | TỊCH — | Vắng mặt, rời chỗ | rule_02 |
| 用件 | ようけん | DỤNG KIỆN | Việc cần (lý do gọi) | rule_02 |
| 承る | うけたまわる | — | (Khiêm nhường) tiếp nhận | rule_02 |
| 申し訳ございません | もうしわけございません | — | Vô cùng xin lỗi (kính ngữ) | rule_03 |
| 誠に | まことに | THÀNH — | Thật sự, chân thành | rule_03 |
| 保留 | ほりゅう | BẢO LƯU | Hold, giữ máy | rule_03 |
| 受話器 | じゅわき | THỤ THOẠI KHÍ | Ống nghe | rule_04 |
| メモ | メモ | — | Ghi chú | rule_04 |
| 復唱 | ふくしょう | PHỤC XƯỚNG | Lặp lại để xác nhận | rule_04 |
| 資料 | しりょう | TƯ LIỆU | Tài liệu | rule_04 |
| 念のため | ねんのため | — | Để chắc chắn | rule_05 |
| 件名 | けんめい | KIỆN DANH | Tiêu đề, chủ đề | rule_05 |
| 対応 | たいおう | ĐỐI ỨNG | Cách xử lý, đáp | rule_05 |
| 高さ | たかさ | — | Độ cao (pitch) | rule_06 |
| 速度 | そくど | TỐC ĐỘ | Tốc độ | rule_06 |
| 半音 | はんおん | BÁN ÂM | Nửa cung (âm nhạc) | rule_06 |
| 語尾 | ごび | NGỮ VĨ | Cuối câu | rule_06 |
| 笑顔 | えがお | TIẾU NHAN | Mặt cười, nụ cười | rule_07 |
| 口角 | こうかく | KHẨU GIÁC | Góc miệng | rule_07 |
| 元気 | げんき | NGUYÊN KHÍ | Khỏe, năng lượng | rule_07 |
| 温度 | おんど | ÔN ĐỘ | Nhiệt độ (giọng — cảm xúc) | rule_07 |
| 環境 | かんきょう | HOÀN CẢNH | Môi trường | rule_08 |
| 背景音 | はいけいおん | BỐI CẢNH ÂM | Tiếng ồn nền | rule_08 |
| 外出中 | がいしゅつちゅう | NGOẠI XUẤT TRUNG | Đang ra ngoài | rule_08 |
| 容赦 | ようしゃ | DUNG XÁ | Tha thứ, thông cảm | rule_08 |
| 整える | ととのえる | — | Sắp xếp | rule_09 |
| ヘッドセット | ヘッドセット | — | Headset | rule_09 |
| 通知 | つうち | THÔNG TRI | Thông báo | rule_09 |
| 想定 | そうてい | TƯỞNG ĐỊNH | Dự đoán | rule_10 |
| 言い訳 | いいわけ | — | Bào chữa | rule_10 |
| 主導権 | しゅどうけん | CHỦ ĐẠO QUYỀN | Quyền chủ động | rule_10 |
| 深呼吸 | しんこきゅう | THÂM HÔ HẤP | Hít thở sâu | rule_10 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|------|
| 確認 | かくにん | XÁC NHẬN | Xác nhận | rule_11 |
| 担当者 | たんとうしゃ | ĐẢM ĐƯƠNG GIẢ | Người phụ trách | rule_11 |
| 繋ぐ | つなぐ | — | Nối, chuyển (máy) | rule_11 |
| いらっしゃる | いらっしゃる | — | (Kính ngữ) là, có | rule_12 |
| 数字 | すうじ | SỐ TỰ | Số | rule_13 |
| 区切る | くぎる | — | Phân đoạn | rule_13 |
| アットマーク | アットマーク | — | @ (at sign) | rule_13 |
| 抜け | ぬけ | — | Thiếu sót | rule_14 |
| 詳細 | しょうさい | TƯỜNG TẾ | Chi tiết | rule_14 |
| 取次ぎ | とりつぎ | — | Chuyển máy | rule_15 |
| 変わる | かわる | — | Đổi (người nói) | rule_15 |
| 不在 | ふざい | BẤT TẠI | Vắng mặt | rule_16 |
| 会議中 | かいぎちゅう | HỘI NGHỊ TRUNG | Đang họp | rule_16 |
| 外出 | がいしゅつ | NGOẠI XUẤT | Ra ngoài | rule_16 |
| あいにく | あいにく | — | Đáng tiếc thay | rule_16 |
| 折り返し | おりかえし | — | Gọi lại | rule_16 |
| 少々 | しょうしょう | — | Một chút | rule_17 |
| 伝言 | でんごん | TRUYỀN NGÔN | Lời nhắn | rule_18 |
| 申し伝える | もうしつたえる | — | (Khiêm) chuyển lời | rule_18 |
| 間違い電話 | まちがいでんわ | — ĐIỆN THOẠI | Gọi nhầm số | rule_19 |
| お確かめ | おたしかめ | — | Kiểm tra (đối phương kiểm tra) | rule_19 |
| お手数ですが | おてすうですが | — | Phiền anh/chị | rule_19 |
| かけ直す | かけなおす | — | Gọi lại | rule_19 |
| 不便 | ふべん | BẤT TIỆN | Bất tiện | rule_20 |
| 傾聴 | けいちょう | KHUYNH THÍNH | Lắng nghe chăm chú | rule_20 |
| 早急に | さっきゅうに | TẢO CẤP | Khẩn trương | rule_20 |
| 左様でございますか | さようでございますか | — | Vâng, em hiểu rồi (kính ngữ) | rule_20 |
| 案内 | あんない | ÁN NỘI | Hướng dẫn | rule_21 |
| 目印 | めじるし | — | Điểm mốc | rule_21 |
| 角 | かど | — | Góc đường | rule_21 |
| 右折 | うせつ | HỮU CHIẾT | Rẽ phải | rule_21 |
| 看板 | かんばん | KHAN BẢN | Bảng hiệu | rule_21 |
| 静かに | しずかに | — | Nhẹ nhàng | rule_22 |
| 失礼いたします | しつれいいたします | — | Xin phép kết thúc (kính ngữ) | rule_22 |
| 報告 | ほうこく | BÁO CÁO | Báo cáo | rule_23 |
| 共有 | きょうゆう | CỘNG HỮU | Chia sẻ | rule_23 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|------|
| 発信 | はっしん | PHÁT TÍN | Gọi đi | rule_24 |
| 目的 | もくてき | MỤC ĐÍCH | Mục đích | rule_24 |
| 時間帯 | じかんたい | THỜI GIAN ĐỚI | Khung giờ | rule_24 |
| 始業 | しぎょう | THỦY NGHIỆP | Bắt đầu giờ làm | rule_25 |
| 終業 | しゅうぎょう | CHUNG NGHIỆP | Hết giờ làm | rule_25 |
...
| 要件 | ようけん | YẾU KIỆN | Việc, mục đích | rule_28 |
| 進捗 | しんちょく | TIẾN THÚC | Tiến độ | rule_28 |
| 期限 | きげん | KỲ HẠN | Hạn chót | rule_28 |
| 前置き | まえおき | — | Lời mở rào | rule_28 |
| 金額 | きんがく | KIM NGẠCH | Số tiền | rule_29 |
| 納期 | のうき | NẠP KỲ | Hạn giao | rule_29 |
| かえって | かえって | — | Ngược lại, càng | rule_30 |
| 添付 | てんぷ | THIÊM PHỤ | Đính kèm | rule_30 |
| オンライン会議 | オンライン かいぎ | — HỘI NGHỊ | Họp trực tuyến | rule_30 |
...
| 終日 | しゅうじつ | CHUNG NHẬT | Cả ngày | rule_32 |
| 時差 | じさ | THỜI SAI | Lệch giờ | rule_33 |
| 略語 | りゃくご | LƯỢC NGỮ | Từ viết tắt | rule_33 |
| 至急 | しきゅう | CHÍ CẤP | Khẩn cấp | rule_33 |
| 国際電話 | こくさいでんわ | QUỐC TẾ ĐIỆN THOẠI | Cuộc gọi quốc tế | rule_33 |
| 即時 | そくじ | TỨC THỜI | Ngay lập tức | rule_34 |
| ずれ込む | ずれこむ | — | Trễ, dời | rule_34 |
| 見込み | みこみ | — | Dự kiến | rule_34 |
| 合意 | ごうい | HỢP Ý | Đồng ý, thống nhất | rule_35 |
| 担当 | たんとう | ĐẢM ĐƯƠNG | Người phụ trách | rule_35 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|------|
| 保留中 | ほりゅうちゅう | BẢO LƯU TRUNG | Đang giữ máy | rule_36 |
| 沈黙 | ちんもく | TRẦM MẶC | Im lặng | rule_36 |
| 途中 | とちゅう | ĐỒ TRUNG | Giữa chừng | rule_37 |
| 切れる | きれる | — | Đứt, ngắt | rule_37 |
| 電波 | でんぱ | ĐIỆN BA | Sóng điện thoại | rule_37 |
| 遠い | とおい | — | Xa (line không rõ) | rule_38 |
| はっきり | はっきり | — | Rõ ràng | rule_38 |
| 聞き返し | ききかえし | — | Hỏi lại | rule_39 |
| 垣 | かき | — | Hàng rào | rule_39 |
| 意味 | いみ | Ý VỊ | Nghĩa | rule_39 |
| 怒る | おこる | — | Giận | rule_40 |
| 共感 | きょうかん | CỘNG CẢM | Đồng cảm | rule_40 |
| 遮る | さえぎる | — | Cắt ngang | rule_40 |
| 再発 | さいはつ | TÁI PHÁT | Tái diễn | rule_41 |
| 防止 | ぼうし | PHÒNG CHỈ | Ngăn chặn | rule_41 |
| 検品 | けんぴん | KIỂM PHẨM | Kiểm hàng | rule_41 |
| 回収 | かいしゅう | HỒI THU | Thu hồi | rule_41 |
| 不良品 | ふりょうひん | BẤT LƯƠNG PHẨM | Hàng lỗi | rule_41 |
| 断る | ことわる | — | Từ chối | rule_42 |
| 婉曲 | えんきょく | UYỂN KHÚC | Vòng vo | rule_42 |
| 代替案 | だいたいあん | ĐẠI THẾ ÁN | Phương án thay thế | rule_42 |
| 延期 | えんき | DIÊN KỲ | Hoãn | rule_43 |
| 変更 | へんこう | BIẾN CANH | Thay đổi | rule_43 |
| 急遽 | きゅうきょ | CẤP CỬ | Đột xuất | rule_43 |
| 出張 | しゅっちょう | XUẤT TRƯƠNG | Công tác | rule_43 |
| 障害 | しょうがい | CHƯỚNG NGẠI | Sự cố | rule_44 |
| 影響範囲 | えいきょうはんい | ẢNH HƯỞNG PHẠM VI | Phạm vi ảnh hưởng | rule_44 |
| 復旧 | ふっきゅう | PHỤC CỰU | Khôi phục | rule_44 |
| 推定 | すいてい | SUY ĐỊNH | Ước tính | rule_44 |
| 謝罪 | しゃざい | TẠ TỘI | Xin lỗi | rule_45 |
| 責任 | せきにん | TRÁCH NHIỆM | Trách nhiệm | rule_45 |
| 徹底 | てってい | TRIỆT ĐỂ | Triệt để | rule_45 |
| 二重化 | にじゅうか | NHỊ TRỌNG HÓA | Tăng gấp đôi (cơ chế kiểm) | rule_45 |
| 貴重 | きちょう | QUÝ TRỌNG | Quý báu | rule_46 |
| 参考 | さんこう | THAM KHẢO | Tham khảo | rule_46 |
| 引き続き | ひきつづき | — | Tiếp tục | rule_46 |
| 督促 | とくそく | ĐỐC XÚC | Đòi nợ | rule_47 |
| 請求書 | せいきゅうしょ | THỈNH CẦU THƯ | Hóa đơn | rule_47 |
| 振込み | ふりこみ | — | Chuyển khoản | rule_47 |
| 行き違い | いきちがい | — | Sự nhầm lẫn | rule_47 |
| 入金 | にゅうきん | NHẬP KIM | Vào tiền | rule_47 |
| 移転 | いてん | DI CHUYỂN | Chuyển trụ sở | rule_48 |
| 正式 | せいしき | CHÍNH THỨC | Chính thức | rule_48 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|------|
| 留守番電話 | るすばんでんわ | LƯU THỦ PHIÊN ĐIỆN THOẠI | Hộp thư thoại | rule_49 |
| 際 | さい | TẾ | Lúc, khi | rule_49 |
| 幸い | さいわい | HẠNH | Mong được | rule_49 |
| 早速 | さっそく | TẢO TỐC | Nhanh chóng | rule_50 |
| フォローアップ | フォローアップ | — | Theo sát sau cuộc gọi | rule_51 |
| 認識合わせ | にんしきあわせ | NHẬN THỨC — | Đồng nhất hiểu biết | rule_51 |
| 合意事項 | ごういじこう | HỢP Ý SỰ HẠNG | Điểm thống nhất | rule_51 |
| 音声 | おんせい | ÂM THANH | Âm thanh | rule_52 |
| 発言 | はつげん | PHÁT NGÔN | Phát biểu | rule_52 |
| 質問 | しつもん | CHẤT VẤN | Câu hỏi | rule_52 |
| 画面共有 | がめんきょうゆう | HỌA DIỆN CỘNG HỮU | Chia sẻ màn hình | rule_53 |
| 表 | ひょう | BIỂU | Bảng | rule_53 |
| 前月比 | ぜんげつひ | TIỀN NGUYỆT TỈ | So với tháng trước | rule_53 |
| 小休止 | しょうきゅうし | TIỂU HƯU CHỈ | Nghỉ ngắn | rule_53 |
| ミュート | ミュート | — | Tắt mic (im tiếng) | rule_54 |
| 雑音 | ざつおん | TẠP ÂM | Tạp âm | rule_54 |
| 待機 | たいき | ĐÃI CƠ | Chờ | rule_54 |
| 国際 | こくさい | QUỐC TẾ | Quốc tế | rule_55 |
| 主言語 | しゅげんご | CHỦ NGÔN NGỮ | Ngôn ngữ chính | rule_55 |
| 不明な点 | ふめいなてん | BẤT MINH — ĐIỂM | Điểm chưa rõ | rule_55 |
| 録音 | ろくおん | LỤC ÂM | Ghi âm | rule_56 |
| 文字起こし | もじおこし | VĂN TỰ — | Chuyển giọng thành văn bản | rule_56 |
| 議事録 | ぎじろく | NGHỊ SỰ LỤC | Biên bản họp | rule_56 |
| 了承 | りょうしょう | LIỄU THỪA | Đồng ý | rule_56 |
| 発言を取る | はつげんをとる | PHÁT NGÔN — | Lấy lượt phát biểu | rule_57 |
| 恐れ入ります | おそれいります | — | Phiền anh/chị, xin lỗi | rule_57 |
| お先に | おさきに | — | Trước (mời người khác đi trước) | rule_57 |
| ハイブリッド | ハイブリッド | — | Kết hợp (trực tiếp + trực tuyến) | rule_58 |
| 参加者 | さんかしゃ | THAM GIA GIẢ | Người tham gia | rule_58 |
| 取り残す | とりのこす | — | Bỏ rơi | rule_58 |
| 配慮 | はいりょ | PHỐI LỰ | Quan tâm | rule_58 |
| 懸念 | けねん | HUYỀN NIỆM | Mối lo | rule_58 |
| 履歴 | りれき | LÝ LỊCH | Lịch sử | rule_59 |
| 記録 | きろく | KÝ LỤC | Ghi nhận | rule_59 |
| 完了 | かんりょう | HOÀN LIỄU | Hoàn thành | rule_59 |
| 自己診断 | じこしんだん | TỰ KỶ CHẨN ĐOÁN | Tự chẩn đoán | rule_60 |
| 弱点 | じゃくてん | NHƯỢC ĐIỂM | Điểm yếu | rule_60 |
| 練習 | れんしゅう | LUYỆN TẬP | Luyện tập | rule_60 |
| 継続 | けいぞく | KẾ TỤC | Liên tục | rule_60 |
