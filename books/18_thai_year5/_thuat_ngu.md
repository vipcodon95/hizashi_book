# Bảng thuật ngữ — Sách 18: Thái Năm 5

> Các viết tắt & thuật ngữ chuyên ngành dùng trong sách. Tra theo bảng chữ cái.
...
| GF | Glass Fiber | Sợi thủy tinh gia cường (vd PA66-GF30 = PA66 + 30% sợi thủy tinh) |
| MC | Machining Center | Trung tâm gia công CNC đa năng (phay, khoan, tarô tự động) |
| Moldex3D | Moldex3D | Phần mềm mô phỏng ép phun nhựa (CAE); phân tích điền khuôn, weldline, warpage |
| MPa | Megapascal | Đơn vị áp suất; 1 MPa ≈ 10 kgf/cm² (dùng chỉ áp giữ trong ép phun) |
| N2 | JLPT Level N2 | Năng lực tiếng Nhật cấp N2 theo kỳ thi JLPT (thang từ N5 thấp → N1 cao) |
| N4 | JLPT Level N4 | Năng lực tiếng Nhật cấp N4 theo kỳ thi JLPT |
| NC | Numerical Control | Điều khiển số; chương trình NC = file lệnh điều khiển máy CNC |
