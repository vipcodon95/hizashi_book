---
title: "Hizashi — Báo·Liên·Tham vấn / 報・連・相 v1.1"
...
| 社内標準 | しゃないひょうじゅん | Chuẩn nội bộ công ty |
...
# Rule 25 — Hỏi judgment material thay vì hỏi đáp án / 答えではなく判断材料を求める
...
| 集中環境 | しゅうちゅうかんきょう | Môi trường tập trung |
...
### Rule 02 — Format báo cáo tiến độ daily/weekly / 進捗報告のフォーマット daily/weekly
...
>
> 🇻🇳 *Em xin báo cáo tiến độ tuần này ạ. Item hoàn thành: 〇〇, đang làm: 〇〇, kế hoạch tuần sau: 〇〇 ạ.*
>
> 📝 _Weekly report 冒頭句_
...
>
> 🇻🇳 *Em báo cáo trung gian 〇〇 ạ. Tiến độ 〇%, điều em cần anh/chị check là 〇〇 ạ.*
>
> 📝 _中間報告の冒頭句_
...
>
> 🇻🇳 *〇〇 từ 〇〇 → 〇〇 (tăng/giảm 〇%) ạ. Sample size là 〇〇.*
>
...
### Rule 08 — Cách viết houkokusho — báo cáo formal kiểu Nhật / 報告書の書き方 (件名/宛先/作成日/概要/詳細/結論/添付)
...
### Rule 12 — Checklist phòng ngừa thiếu báo cáo / 報告漏れ防止 (10項目セルフチェック)

**ズン (em Dũng):**

> 🇯🇵 「今週の報告漏れチェック完了です。受信〇件／返信〇件／未返信〇件です。」
>
> 🇻🇳 *Em đã chạy xong checklist tuần này. Nhận 〇 / reply 〇 / chưa reply 〇 ạ.*
>
> 📝 _週末セルフチェック報告冒頭_
...
>
> 🇻🇳 *Mọi người, em xin chia sẻ khẩn. Có 〇〇 đã xảy ra. Tạm thời mọi người 〇〇 giúp em. Chi tiết em share trước 〇〇.*
>
> 📝 _15分ルール緊急共有テンプレート_
...
>
> 🇻🇳 *Tiêu đề [〇 quyết định] 〇〇. TL;DR: 〇〇. Action by assignee: @〇〇 - 〇〇 / @〇〇 - 〇〇. Next check-in: 〇〇.*
>
...
>
> 🇻🇳 *Quyết channel theo urgency × số người nhận. Critical thì 2 lớp điện thoại + Slack.*
>
> 📝 _channel 選択原則の暗記用_


### Rule 16 — Slack channel etiquette / Slack マナー (@here / @channel / threads / DM)

**ズン (em Dũng):**

> 🇯🇵 「@here 〇〇をアップロードしました。本日中にご確認をお願いいたします。」
>
> 🇻🇳 *@here em đã upload 〇〇. Phiền mọi người check trong hôm nay ạ.*
>
...
>
> 🇻🇳 *@channel có quy tắc vận hành là chỉ dùng khi khẩn cấp như sự cố production.*
>
> 📝 _@channel 過剰使用への丁寧な指摘_


### Rule 17 — Liên lạc khẩn cấp + thứ tự ưu tiên / 緊急連絡の優先順位 (escalation path)
...
> 🇯🇵 「当方にてカレンダー更新および新規招待をお送りいたします。」
>
> 🇻🇳 *Em sẽ update lịch và gửi invite mới ạ.*
>
> 📝 _リスケ後の更新責任明示_
...
>
> 🇻🇳 *Em báo công tác 〇〇 từ 〇/〇 - 〇/〇 ạ. Deliverable kỳ vọng là 〇〇, tiến độ daily em share Slack lúc 〇〇h ạ.*
>
> 📝 _出張連絡の冒頭句_
...
>
> 🇻🇳 *[EOD Handoff VN→JP] Done today: 〇〇 / Chờ JP review: 〇〇 / JP team sáng check: 〇〇.*
>
> 📝 _daily EOD handoff message_
...
>
> 🇻🇳 *Vì phạm vi ảnh hưởng 〇〇 + tính rollback 〇〇 nên em tự quyết / xin tham vấn ạ.*
>
> 📝 _判断軸を明示するフレーズ_
...
>
> 🇻🇳 *Em phân vân giữa A và B. Có axis nào em đang bỏ sót không ạ?*
>
> 📝 _見落とし系の判断材料リクエスト_
...
>
> 🇻🇳 *Em đã chuẩn bị 〇 phương án. So sánh theo cost / time / risk ạ.*
>
> 📝 _複数案相談の切り出し_
...
>
> 🇻🇳 *Em recommend phương án 〇. Lý do: 〇〇 + 〇〇 + 〇〇.*
>
> 📝 _推奨案の明示_


### Rule 27 — Lưu log tham vấn / 相談ログ (Decision Register)
...
>
> 🇻🇳 *Em đã mở ticket: hứa khách 〇〇, deadline nội bộ 〇〇 (trước 1 ngày), owner 〇〇.*
>
> 📝 _持ち帰りチケット起票報告_
...
>
> 🇻🇳 *Vì 〇〇 nên em sẽ nghỉ từ 〇/〇 trong 〇 tháng, hôm nay em báo trước 〇 tháng ạ. Em đã chuẩn bị draft Handover Plan ạ.*
>
> 📝 _退職・長期休暇の上司報告冒頭_


### Rule 34 — Mentoring Hou-Ren-Sou cho junior mới / 新人指導（Hou-Ren-Sou メンタリング）

**ズン (em Dũng):**

> 🇯🇵 「サポート体制を3つ整えました: Weekly 1-on-1、Slack Office Hour、期待値の明文化。」
>
> 🇻🇳 *Anh set xong 3 thứ support: Weekly 1-on-1, Slack Office Hour, kỳ vọng rõ ràng.*
>
> 📝 _新人指導開始時の構造提示_
...
>
> 🇻🇳 *Khẩn cấp (đang xử khách, ảnh hưởng production, cần quyết trong 3 giờ) thì @ ngay, còn lại Office Hour.*
>
> 📝 _緊急定義の明文化_


### Rule 35 — Hou-Ren-Sou khi work-from-home / リモートワーク時のホウレンソウ

**リン (em Linh):**

> 🇯🇵 「【Daily 〇/〇 WFH 🏠】Done: 〇〇 / Doing: 〇〇 / Blocked: 〇〇 / Next: 〇〇。ステータス: 🟢 working until 〇〇 ICT。」
>
> 🇻🇳 *[Daily 〇/〇 WFH 🏠] Done: 〇〇 / Doing: 〇〇 / Blocked: 〇〇 / Next: 〇〇. Status: 🟢 working until 〇〇 ICT.*
>
...
>
> 🇻🇳 *[EOD 〇/〇] Done: 〇〇 / Sang mai: 〇〇 / Top 3 mai: 〇〇. Status: 🟢 → 🌙 EOD.*
>
> 📝 _EOD ログ標準フォーマット_


### Rule 36 — Bridging gap VN-JP HouRenSou / VN-JP オフショア・ギャップ (報告頻度)

**ズン (em Dũng):**

> 🇯🇵 「進捗共有の予定: 〇〇EOD: 〇〇 / 〇〇EOD: 〇〇 / 〇〇: 完成版送付。途中で blocker あればすぐご連絡いたします。」
>
> 🇻🇳 *[Lịch chia sẻ tiến độ] 〇〇 EOD: 〇〇 / 〇〇 EOD: 〇〇 / 〇〇: gửi bản cuối. Có blocker em báo ngay ạ.*
>
> 📝 _タスク開始時の reporting cadence pre-commit_

**ズン (em Dũng):**

> 🇯🇵 「【中間報告】〇〇 / ブロッカーなし、予定通り進行中。」
>
> 🇻🇳 *[Báo cáo trung gian] 〇〇 / Không có blocker, đúng kế hoạch.*
>
...
### Rule 38 — Self-diagnostic Hou-Ren-Sou 15 mục / Hou-Ren-Sou 自己診断15項目
...
>
> 📝 _evidence ベースの自己診断結果報告_


### Rule 39 — Xây dựng team culture Hou-Ren-Sou / チーム Hou-Ren-Sou 文化作り

**ハー (anh Hà):**

> 🇯🇵 「Playbook v〇 を共有します。5要素構成: Rituals / Dashboard / OKR / Escalation / Onboarding。」
>
> 🇻🇳 *Em share Playbook v〇. Cấu trúc 5 thành phần: Rituals / Dashboard / OKR / Escalation / Onboarding.*
>
> 📝 _Playbook 提示の宣言_


### Rule 40 — Reflection + cải tiến hàng tuần / 週次 retrospective (KPT)

**フオン副部長 (chị Hương):**

> 🇯🇵 「30分、KPT format。Notion テンプレに事前記入できた人から発表。」
>
> 🇻🇳 *30 phút, format KPT. Ai pre-fill template Notion xong thì present trước.*
>
...
>
> 🇻🇳 *Action items: 〇〇 (owner: 〇〇, deadline: 〇〇, check: retro tuần sau).*
>
> 📝 _Action items 化の定型_
...
| 報告 | ほうこく | Báo cáo | rule_01 |
| 結論 | けつろん | Kết luận | rule_01 |
| 事実 | じじつ | Sự thật | rule_01 |
| 私見 | しけん | Ý kiến cá nhân | rule_01 |
| 経過 | けいか | Quá trình / diễn biến | rule_01 |
| タイムリー | taimurī | Kịp thời | rule_01 |
| 切り分け | きりわけ | Phân tách (vấn đề) | rule_01 |
| 対応方針 | たいおうほうしん | Phương án xử lý | rule_01 |
| 進捗 | しんちょく | Tiến độ | rule_02 |
| 完了 | かんりょう | Hoàn thành | rule_02 |
| 着手 | ちゃくしゅ | Bắt đầu (việc) | rule_02 |
| 対応 | たいおう | Xử lý | rule_02 |
| 見込み | みこみ | Dự kiến / triển vọng | rule_02 |
| 指摘 | してき | Comment / chỉ ra điểm cần sửa | rule_02 |
| 同期 | どうき | Đồng bộ | rule_02 |
| ブロック | burokku | Blocker (vật cản) | rule_02 |
| 結果報告 | けっかほうこく | Báo cáo kết quả | rule_03 |
| 目標 | もくひょう | Mục tiêu | rule_03 |
| 原因分析 | げんいんぶんせき | Phân tích nguyên nhân | rule_03 |
| 致命的 | ちめいてき | Nghiêm trọng / chí mạng | rule_03 |
| 仮承認 | かりしょうにん | Phê duyệt sơ bộ | rule_03 |
| 論点 | ろんてん | Điểm tranh luận | rule_03 |
| 細部 | さいぶ | Chi tiết nhỏ | rule_03 |
| キックオフ | kikkuofu | Kick-off | rule_03 |
| 中間報告 | ちゅうかんほうこく | Báo cáo trung gian | rule_04 |
| 構成 | こうせい | Cấu trúc / bố cục | rule_04 |
| エグゼクティブサマリー | egzekutibu samarī | Executive summary | rule_04 |
| 軌道修正 | きどうしゅうせい | Điều chỉnh hướng đi | rule_04 |
...
| 前週比 | ぜんしゅうひ | So với tuần trước | rule_06 |
| 母数 | ぼすう | Sample size / cỡ mẫu | rule_06 |
| 体感 | たいかん | Cảm nhận chủ quan | rule_06 |
| 改善 | かいぜん | Cải thiện | rule_06 |
| 大幅 | おおはば | Đáng kể (mơ hồ — tránh) | rule_06 |
| ダッシュボード | dasshubōdo | Dashboard | rule_06 |
| 根拠 | こんきょ | Cơ sở / căn cứ | rule_06 |
| 緊急 | きんきゅう | Khẩn cấp | rule_07 |
| 発生 | はっせい | Xảy ra (sự cố) | rule_07 |
| 影響範囲 | えいきょうはんい | Phạm vi ảnh hưởng | rule_07 |
| 対応案 | たいおうあん | Phương án xử lý | rule_07 |
| 第一報 | だいいっぽう | Báo cáo đầu tiên | rule_07 |
| トランザクション | toranzakushon | Transaction | rule_07 |
| データ消失 | データしょうしつ | Mất dữ liệu | rule_07 |
| 復旧 | ふっきゅう | Khôi phục | rule_07 |
| 折り返し | おりかえし | Gọi lại / phản hồi lại | rule_07 |
| 報告書 | ほうこくしょ | Báo cáo văn bản | rule_08 |
| 件名 | けんめい | Tiêu đề | rule_08 |
| 宛先 | あてさき | Người nhận | rule_08 |
| 作成日 | さくせいび | Ngày lập | rule_08 |
| 概要 | がいよう | Tổng quan / executive summary | rule_08 |
| 詳細 | しょうさい | Chi tiết | rule_08 |
| 添付 | てんぷ | Đính kèm | rule_08 |
| 提言 | ていげん | Kiến nghị | rule_08 |
| ドラフト | dorafuto | Bản nháp | rule_08 |
| 社内標準 | しゃないひょうじゅん | Chuẩn nội bộ công ty | rule_08 |
| 口頭 | こうとう | Miệng / nói | rule_09 |
| 書面 | しょめん | Văn bản | rule_09 |
| 用件 | ようけん | Việc cần báo / business | rule_09 |
| センシティブ | sensitibu | Nhạy cảm | rule_09 |
| フォローアップ | forōappu | Follow up | rule_09 |
| 監査証跡 | かんさしょうせき | Audit trail | rule_09 |
| 朝礼 | ちょうれい | Morning standup | rule_10 |
| 昨日 | きのう | Hôm qua | rule_10 |
| 今日 | きょう | Hôm nay | rule_10 |
| 困りごと | こまりごと | Việc đang gặp khó / blocker | rule_10 |
| リファクタ | rifakuta | Refactor | rule_10 |
| 解釈 | かいしゃく | Cách hiểu / diễn giải | rule_10 |
| 1-on-1 | わんおんわん | 1-on-1 talk | rule_10 |
| 流れ | ながれ | Flow / dòng chảy | rule_10 |
| 弊社 | へいしゃ | Cty chúng tôi (khiêm nhường) | rule_11 |
| ご報告申し上げます | ごほうこくもうしあげます | Em xin trân trọng báo cáo | rule_11 |
| かみ砕く | かみくだく | Giải thích đơn giản | rule_11 |
| 役職敬称 | やくしょくけいしょう | Title chức vụ | rule_11 |
| 仕組み | しくみ | Cơ chế / hệ thống | rule_11 |
| 技術検証 | ぎじゅつけんしょう | Kiểm chứng kỹ thuật | rule_11 |
| ジャーゴン | jāgon | Jargon / thuật ngữ | rule_11 |
| 報告漏れ | ほうこくもれ | Báo cáo thiếu / sót | rule_12 |
| チェックリスト | chekkurisuto | Checklist | rule_12 |
| 未返信 | みへんしん | Chưa reply | rule_12 |
| 期日 | きじつ | Hạn / deadline | rule_12 |
| 可視化 | かしか | Trực quan hóa | rule_12 |
| セルフチェック | serufu chekku | Tự kiểm | rule_12 |
| 書面化 | しょめんか | Đưa thành văn bản | rule_12 |
| 約束 | やくそく | Lời hứa / cam kết | rule_12 |
...
| 漢字 / Tiếng Nhật | Cách đọc (Romaji) | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|
| 即時性 | そくじせい | Tức thời | rule_13 |
| 連絡 | れんらく | Liên lạc / chia sẻ thông tin | rule_13 |
| 鮮度 | せんど | Độ tươi | rule_13 |
| 緊急共有 | きんきゅうきょうゆう | Chia sẻ khẩn | rule_13 |
| 保留 | ほりゅう | Tạm dừng | rule_13 |
| 寝かせる | ねかせる | Ngâm tin (negative) | rule_13 |
| 価値 | かち | Giá trị | rule_13 |
| 続行 | ぞっこう | Tiếp tục (việc) | rule_13 |
| 全員 | ぜんいん | Toàn thể | rule_14 |
| 決定事項 | けっていじこう | Hạng mục đã quyết | rule_14 |
| 担当 | たんとう | Người phụ trách | rule_14 |
| 優先順位 | ゆうせんじゅんい | Thứ tự ưu tiên | rule_14 |
| 進捗確認 | しんちょくかくにん | Xác nhận tiến độ | rule_14 |
| 抜き出す | ぬきだす | Trích ra | rule_14 |
| 構造 | こうぞう | Cấu trúc | rule_14 |
| チャネル | chaneru | Channel | rule_15 |
| 緊急度 | きんきゅうど | Mức độ khẩn | rule_15 |
| 受信者 | じゅしんしゃ | Người nhận | rule_15 |
| 通常 | つうじょう | Bình thường | rule_15 |
| 長期参照 | ちょうきさんしょう | Tham khảo dài hạn | rule_15 |
| 二重 | にじゅう | Hai lớp | rule_15 |
| マトリクス | matorikusu | Matrix | rule_15 |
| 流れる | ながれる | Trôi đi (mất tin) | rule_15 |
| 運用ルール | うんようルール | Quy tắc vận hành | rule_16 |
| 緊急時 | きんきゅうじ | Khi khẩn cấp | rule_16 |
| 本番障害 | ほんばんしょうがい | Sự cố production | rule_16 |
| メンション | menshon | Mention | rule_16 |
| スレッド | sureddo | Thread | rule_16 |
| 関連投稿 | かんれんとうこう | Bài đăng liên quan | rule_16 |
| 拝見 | はいけん | Xem (khiêm) | rule_16 |
| 承認 | しょうにん | Phê duyệt | rule_16 |
| 緊急連絡 | きんきゅうれんらく | Liên lạc khẩn | rule_17 |
| 直属上司 | ちょくぞくじょうし | Cấp trên trực tiếp | rule_17 |
...
| お手数 | おてすう | Phiền (làm phiền) | rule_18 |
| 不在 | ふざい | Vắng mặt | rule_19 |
| 休暇 | きゅうか | Nghỉ phép | rule_19 |
| 病欠 | びょうけつ | Nghỉ ốm | rule_19 |
| 復帰日 | ふっきび | Ngày trở lại | rule_19 |
| 代行者 | だいこうしゃ | Người đại diện / cover | rule_19 |
| 引き継ぎ | ひきつぎ | Bàn giao | rule_19 |
| 自動返信 | じどうへんしん | Auto-reply | rule_19 |
| 終日 | しゅうじつ | Cả ngày | rule_19 |
| 出張 | しゅっちょう | Công tác | rule_20 |
| 訪問先 | ほうもんさき | Nơi đến / địa điểm | rule_20 |
| 同行者 | どうこうしゃ | Người đi cùng | rule_20 |
| 期待する | きたいする | Kỳ vọng | rule_20 |
| 移動時間帯 | いどうじかんたい | Khung giờ di chuyển | rule_20 |
| デモ | demo | Demo | rule_20 |
| 数値ベース | すうちベース | Dựa trên số liệu | rule_20 |
| 時差 | じさ | Múi giờ | rule_21 |
| 海外チーム | かいがいチーム | Team nước ngoài | rule_21 |
| 併記 | へいき | Ghi cả hai | rule_21 |
| 終業時 | しゅうぎょうじ | End of day | rule_21 |
| 始業時 | しぎょうじ | Start of day | rule_21 |
| 同期的 | どうきてき | Sync (đồng bộ) | rule_21 |
| 非同期 | ひどうき | Async | rule_21 |
...
| 漢字 / Tiếng Nhật | Cách đọc (Romaji) | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|
| 相談 | そうだん | Tham vấn | rule_22 |
| 自己決定 | じこけってい | Tự quyết | rule_22 |
| 判断軸 | はんだんじく | Trục đánh giá | rule_22 |
| 可逆性 | かぎゃくせい | Tính rollback được | rule_22 |
| 不可逆 | ふかぎゃく | Không rollback được | rule_22 |
| 事後報告 | じごほうこく | Báo cáo sau khi đã làm | rule_22 |
| 稟議 | りんぎ | Quy trình duyệt nội bộ | rule_22 |
| 仮説 | かせつ | Giả thuyết / phán đoán ban đầu | rule_23 |
| 丸投げ | まるなげ | Đẩy hết / phó mặc | rule_23 |
| 参考事例 | さんこうじれい | Case-study tham chiếu | rule_23 |
| 代替案 | だいたいあん | Phương án thay thế | rule_23 |
| 権限 | けんげん | Quyền (quyết) | rule_23 |
| 状況整理 | じょうきょうせいり | Tổ chức tình huống | rule_23 |
| 切り出し | きりだし | Cách mở lời | rule_24 |
| お時間 | おじかん | Thời gian (kính ngữ) | rule_24 |
| 判断材料 | はんだんざいりょう | Dữ kiện ra quyết định | rule_24 |
...
| 待機体制 | たいきたいせい | Cơ chế trực | rule_25 |
| 複数案 | ふくすうあん | Nhiều phương án | rule_26 |
| 持参 | じさん | Mang theo | rule_26 |
| 推奨 | すいしょう | Đề xuất / khuyên dùng | rule_26 |
| 比較 | ひかく | So sánh | rule_26 |
| 定量化 | ていりょうか | Định lượng | rule_26 |
| 運用工数 | うんようこうすう | Chi phí vận hành (giờ) | rule_26 |
| メンテナンスウィンドウ | maintenance window | Cửa sổ bảo trì | rule_26 |
| 不整合 | ふせいごう | Không nhất quán | rule_26 |
| 相談ログ | そうだんログ | Log tham vấn | rule_27 |
| 決定 | けってい | Quyết định | rule_27 |
| 採用案 | さいようあん | Phương án được chọn | rule_27 |
| 検討案 | けんとうあん | Phương án được xem xét | rule_27 |
| 承認者 | しょうにんしゃ | Người duyệt | rule_27 |
| 整備する | せいびする | Sắp xếp / build hệ thống | rule_27 |
| 受ける側 | うけるがわ | Bên nhận (tham vấn) | rule_28 |
| 要約 | ようやく | Tóm tắt | rule_28 |
| 復唱 | ふくしょう | Lặp lại | rule_28 |
| 即答 | そくとう | Trả lời ngay | rule_28 |
| コーチング | coaching | Coaching | rule_28 |
...
| 社内期限 | しゃないきげん | Deadline nội bộ | rule_30 |
| 顧客期限 | こきゃくきげん | Deadline với khách | rule_30 |
| チケット | ticket | Ticket | rule_30 |
| 起票 | きひょう | Mở entry / log | rule_30 |
| ボード | board | Board (kanban) | rule_30 |
| ステータス | status | Trạng thái | rule_30 |
...
| 漢字 / Tiếng Nhật | Cách đọc (Romaji) | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|
| 検知 | けんち | Phát hiện | rule_31 |
| 障害 | しょうがい | Sự cố | rule_31 |
| エスカレーション | escalation | Escalate | rule_31 |
| ETA | ETA | Estimated time of arrival | rule_31 |
| ポストモーテム | post-mortem | Post-mortem | rule_31 |
| Sev1 | Sev1 | Critical severity | rule_31 |
| クレーム | claim | Khiếu nại / phàn nàn | rule_32 |
| 傾聴 | けいちょう | Lắng nghe (chủ động) | rule_32 |
| 仮謝罪 | かりしゃざい | Xin lỗi tạm (chưa nhận lỗi cụ thể) | rule_32 |
| 検証 | けんしょう | Verify / xác minh | rule_32 |
| 訂正 | ていせい | Đính chính / sửa | rule_32 |
| 再発防止 | さいはつぼうし | Ngăn tái phát | rule_32 |
| 重複計上 | ちょうふくけいじょう | Tính trùng | rule_32 |
| ご不便 | ごふべん | Sự bất tiện (kính ngữ) | rule_32 |
| 退職 | たいしょく | Nghỉ việc | rule_33 |
| サバティカル | sabbatical | Sabbatical | rule_33 |
| ハンドオーバー | handover | Handover | rule_33 |
| 候補者 | こうほしゃ | Người kế nhiệm tiềm năng | rule_33 |
| ランブック | runbook | Runbook | rule_33 |
| Overlap期間 | overlap きかん | Khoảng overlap | rule_33 |
| 名義 | めいぎ | Đứng tên | rule_33 |
| 新人指導 | しんじんしどう | Đào tạo người mới | rule_34 |
| Office Hour | office hour | Giờ mở cửa hỏi | rule_34 |
| 期待値 | きたいち | Kỳ vọng | rule_34 |
| 明文化 | めいぶんか | Diễn đạt thành văn | rule_34 |
| 蓄積 | ちくせき | Tích lũy | rule_34 |
| 質問ボード | しつもんボード | Bảng câu hỏi | rule_34 |
| 集中環境 | しゅうちゅうかんきょう | Môi trường tập trung | rule_34 |
| リモート | remote | Remote | rule_35 |
| 在宅 | ざいたく | Tại nhà | rule_35 |
| 朝会 | あさかい | Họp sáng / standup | rule_35 |
| EOD ログ | EOD log | Log cuối ngày | rule_35 |
| 校正版 | こうせいばん | Bản đã hiệu đính | rule_35 |
| 集中モード | しゅうちゅうモード | Chế độ tập trung | rule_35 |
| カメラON | camera on | Bật camera | rule_35 |
| 沈黙 | ちんもく | Im lặng | rule_36 |
| 進捗共有 | しんちょくきょうゆう | Chia sẻ tiến độ | rule_36 |
| ブロッカー | blocker | Blocker | rule_36 |
| オフショア | offshore | Offshore | rule_36 |
| ギャップ | gap | Khoảng cách | rule_36 |
| 文化的差異 | ぶんかてきさい | Khác biệt văn hóa | rule_36 |
| 予定通り | よていどおり | Đúng kế hoạch | rule_36 |
...
| 客観 | きゃっかん | Khách quan | rule_38 |
| 主観 | しゅかん | Chủ quan | rule_38 |
| 履歴 | りれき | Lịch sử | rule_38 |
| 照合 | しょうごう | Đối chiếu | rule_38 |
| 改善計画 | かいぜんけいかく | Kế hoạch cải thiện | rule_38 |
| 推移 | すいい | Diễn biến / xu hướng | rule_38 |
| チーム文化 | チームぶんか | Văn hóa team | rule_39 |
| プレイブック | playbook | Playbook | rule_39 |
| Rituals | rituals | Nghi thức / quy trình lặp | rule_39 |
| OKR | OKR | OKR | rule_39 |
| カバレッジ | coverage | Tỉ lệ phủ | rule_39 |
| 文化醸成 | ぶんかじょうせい | Nuôi dưỡng văn hóa | rule_39 |
| 1人立ち | ひとりだち | Tự đứng (hoạt động độc lập) | rule_39 |
| KPT | KPT | Keep/Problem/Try | rule_40 |
| 試行 | しこう | Thử / experiment | rule_40 |
| 継続 | けいぞく | Tiếp tục | rule_40 |
| 課題 | かだい | Vấn đề / challenge | rule_40 |
| 進捗 review | しんちょく review | Review tiến độ | rule_40 |
| ファシリテーター | facilitator | Facilitator | rule_40 |
| pre-fill | pre-fill | Điền trước | rule_40 |
...
- A) ローカルブランチで未マージの変数名リネーム
- B) 個人のSlackステータスを更新
- **C) 本番DB の主キーカラム名変更（5万レコード影響）**
- D) 自分のテストデータをリセット
...
### J3.25 (từ rule_31 — Phát hiện bug — Hou-Ren-Sou flow)
...
- A) 原因を推測して伝える
- **B) 発生事実 + 影響範囲 + 調査中ステータス（原因とETAは未確定なら別途）**
- C) 解決時間を約束する
- D) 客先には復旧後にまとめて報告
...
- A) そんなはずないと思います
- B) 今日中に直して送り直します
- **C) 〇〇とのこと、ご認識合っておりますでしょうか。ご不便をおかけし申し訳ございません**
- D) 経理に確認しないと分かりません
...
- A) Slack #general で全社broadcast
- **B) Tech lead に1-on-1 で Handover Plan ドラフト持参**
- C) 客先の Matsumoto に直接メール
- D) HR にメールのみ
...
- A) 「いつでも聞いて」とだけ伝える
- **B) Weekly 1-on-1 + Slack Office Hour + 期待値明文化の3点**
- C) 新人の DM はすべて即返信する
- D) 週末にまとめて回答する
...
- A) 完成時にまとめて報告
- B) 進捗があった時のみ連絡
- **C) 開始時に reporting cadence を約束し、毎日 EOD に『ブロッカーなし、予定通り』でも1行報告**
- D) Slack に一日中張り付く
...
- A) Slack に20MB PDFを投稿
- **B) Notion ページで編集権付き URL 共有**
- C) 口頭電話で読み上げる
- D) Twitter DM
...
- A) 完璧なので何もしない
- B) 全Aを上司に報告して褒められる
- **C) Slack履歴・DR・客先メールと照合して再診断**
- D) 翌月から診断頻度を半年に1回に下げる
...
- A) Slack / Email / 電話 / Zoom / Notion
- **B) Rituals / Dashboard / OKR / Escalation matrix / Onboarding**
- C) 報告 / 連絡 / 相談 / 会議 / 評価
- D) 個人rule のリスト
...
- A) 明日10時から
- B) 夕方頃に
- **C) 2026/4/22 (火) 10:00 JST (= 08:00 ICT)**
- D) 業務時間内に
...
### Rule 18 — Template email xin reschedule
...
```
[Subject] [Xin reschedule] Họp 〇〇 〇:〇〇 〇/〇 (〇)
...
📝 **Ghi chú VN:** Tiêu đề ghi rõ '[Xin reschedule]'. Lý do nói 1 dòng ngắn (không cần chi tiết nội bộ). Tối thiểu 3 option, bắt buộc kèm JST. Show rõ trách nhiệm update lịch để khách không phải lo.
📝 **Ghi chú JP:** 件名で「リスケ依頼」と明記。理由は1行で簡潔に（社内詳細は不要）。候補は最低3つ、JST 表記必須。更新責任を明示することで相手の負担を取り除く。


## Checklist (3 mẫu)

### Rule 12 — Checklist phòng ngừa báo cáo sót — 10 mục
...
[ ] 2. Đã reply những cái cần reply chưa? (Số chưa reply: 〇)
[ ] 3. Việc nhận bằng miệng đã chuyển thành văn bản (mail/Slack) chưa?
[ ] 4. Deadline đã hứa (nội bộ + ngoại bộ) đã xong đúng hạn chưa?
[ ] 5. Cái nào không kịp đã xin reschedule trước chưa?
[ ] 6. Đã gửi báo cáo tiến độ daily cho sếp chưa? (Format DDBN)
[ ] 7. Việc cần chia sẻ tiến độ cho khách đã gửi chưa?
[ ] 8. Tin xấu đã báo cáo đầu trong vòng 30 phút từ lúc phát sinh chưa?
[ ] 9. Nghiệm thu / phê duyệt / OK đã có văn bản chưa? (OK miệng đã convert chưa?)
[ ] 10. Lịch ngày mai / tuần sau có thay đổi gì cần báo khách trước không?

[Mục ghi chép]
  - Số chưa reply: 〇 (nội dung: 〇〇)
  - Tỉ lệ đạt deadline: 〇/〇
  - Số việc verbal đã convert thành văn bản: 〇
  - Task chuyển sang ngày/tuần sau: 〇
```

📝 **Ghi chú VN:** Đặt alarm 17h hàng ngày để bắt buộc chạy. Mục đích không phải tick hết 10 mục mà là visualize cái nào còn pending. Báo 0 hết = đáng nghi.
📝 **Ghi chú JP:** 毎日17時にアラームで実行を強制。10項目を全部「チェック」より、未対応がある項目を可視化することが目的。0件報告は逆に怪しい。

### Rule 38 — Checklist Self-diagnostic Hou-Ren-Sou 15 mục
...
[Báo cáo (Hōkoku) — 5 mục]
  ...
  [ ] [4] Show deadline: Next action có deadline cụ thể không?
...
[Tham vấn (Sōdan) — 5 mục]
  [ ] [11] Mang nhiều phương án: Tham vấn sếp/khách có mang 2-3 option + pros/cons không?
  [ ] [12] Giả thuyết: Có trình bày giả thuyết + lý do 1-2 dòng không?
  [ ] [13] Hỏi dữ kiện: Có thái độ hỏi 'axis bỏ sót' thay vì 'cái nào hơn' không?
...
[Mục ghi chép]
  ...
  - Case cụ thể của C-D:
    1. 〇〇
    2. 〇〇
  - Action Plan (target lần chấm sau cuối tháng 5):
    1. 〇〇
    2. 〇〇
  - Ngày diagnostic lại: 〇/〇
  - Số DR entry: DR-YYYY-MMDD
```

📝 **Ghi chú VN:** Chấm khắt khe mới đúng. A ≥12 = tự động cảnh báo self-bias. C-D ≥ 3 thì set 1-on-1 với mentor ngay. Mỗi 3 tháng vẽ chart xu hướng để thấy tăng trưởng dài hạn.
📝 **Ghi chú JP:** 評価は厳しめが正解。A 12個以上は自動的に self-bias 警告。C-D が 3項目以上なら mentor 1-on-1 を即座にセット。3ヶ月毎に推移をグラフ化して長期成長を見える化する。

### Rule 40 — Template Retrospective hàng tuần KPT
...
```
[Retrospective hàng tuần / Mỗi thứ Sáu 16:00-16:30]
Thành viên: toàn team Thiên Phát (gồm mentor)
Facilitator: chị Hương (backup: anh Tuấn)
...
[2 Problem (Vấn đề tuần này — cần giải quyết)]
  [ ] 〇〇 (case cụ thể + impact: tốn 〇 giờ / ảnh hưởng khách / etc.)
  [ ] 〇〇
  [ ] 〇〇
...
[Mục ghi chép]
  ...
  - Retro tiếp theo: thứ Sáu 〇/〇 16:00
  - ID đăng ký Decision Register: DR-YYYY-MMDD-〇〇
```

📝 **Ghi chú VN:** Pre-fill bắt buộc. Brainstorm tại chỗ thì 30 phút thành 60 phút. Action items thiếu owner + deadline + check date là không thực thi. Đầu retro review Action tuần trước = đóng kín vòng cải thiện.
...
### Rule 02 — Template báo cáo tiến độ Daily (Slack)
...
📝 **Ghi chú VN:** Trên Slack mỗi dòng xuống dòng. Không thread (sếp lướt không thấy). Blocked dù không có vẫn ghi 「なし」 (nashi = không có).
📝 **Ghi chú JP:** Slack の場合は1行ずつ改行。スレッド化禁止（流し読み出来なくなる）。Blocked が「なし」でも欄を残す。

### Rule 02 — Template báo cáo tiến độ Weekly (Mail)
...
```
[Subject] [Báo cáo tuần] Dự án 〇〇 — Tuần 〇 (〇/〇-〇/〇)
...
📝 **Ghi chú VN:** Weekly bắt buộc có ít nhất 1 con số. Blocker không có vẫn ghi 「なし」 (nashi = không có). Kế hoạch tuần sau giới hạn 3 item trở xuống.
📝 **Ghi chú JP:** Weekly は数字を必ず1つは入れる。Blocker が無ければ「なし」と明記。来週の予定は3項目以内に絞る。

### Rule 05 — Template báo cáo hoàn thành
...
```
[Subject] [Báo cáo hoàn thành] Dự án 〇〇 Phase 〇
...
[Acceptance (Trạng thái nghiệm thu)]
...
📝 **Ghi chú VN:** Section Acceptance phải ghi rõ ngày nghiệm thu + tên file văn bản. Lessons gồm 3 mục: Tốt, Cần cải thiện, Áp dụng cho phase sau.
📝 **Ghi chú JP:** Acceptance セクションで検収日と検収書名を明記。Lessons は「良かった点」「改善点」「次への適用」の3点セットで。

### Rule 07 — Template báo cáo tin xấu (báo cáo đầu)
...
```
[Subject] [Khẩn - Báo đầu] Báo cáo sự cố 〇〇 (〇/〇 〇〇:〇〇)
...
[Impact (Ảnh hưởng)]
  - Phạm vi: 〇〇 (〇〇 case / 〇〇 người / khoảng 〇〇 yên)
  - Thiệt hại đã xác nhận: 〇〇

[Plan (Phương án)]
  1. 〇〇 (PIC: 〇〇 / deadline: 〇〇:〇〇)
  2. 〇〇 (PIC: 〇〇 / deadline: 〇〇:〇〇)
  3. 〇〇 (PIC: 〇〇 / deadline: 〇〇:〇〇)

[Ask (Tham vấn / xin chỉ thị)]
  - Em 〇〇 được không ạ?
  - Hoặc lựa chọn 〇〇 ạ.
...
📝 **Ghi chú VN:** Không có Predict thì người nhận choáng ngợp. Plan tối thiểu 3 action, mỗi cái có owner + deadline. Báo trước giờ báo lần sau giúp sếp không phải truy đuổi.
📝 **Ghi chú JP:** Predict 句が無いと相手は心構え無しに被害情報を受ける。Plan は最低3アクション、各 owner + 期限を必ず付ける。次回報告時刻を予告することで上司が無駄に追わなくて済む。

### Rule 08 — Template báo cáo hoàn thành (formal 7 phần)
...
1. Danh sách deliverable
   ...
   ...
2. Trạng thái KPI
   2-1. Load time: 1.2s → 0.4s (-67%)
   2-2. Bug: 20/tuần → 6/tuần (-70%)
   ...
...
📝 **Ghi chú VN:** Tiêu đề viết to ở dòng đầu. Người nhận chia 3 nhóm 'Chính / CC / Nội bộ'. Tổng quan đủ ngắn để cấp quản lý đọc 3 giây (200-300 chữ). Đính kèm bắt buộc ghi tên + ngày phát hành/version.
📝 **Ghi chú JP:** 件名は1行目に大書、宛先は『主・CC・社内』を分けて書く。概要は経営層が3秒で読める長さ（200-300字）。添付は名称＋発行日／バージョンを必ず併記。

### Rule 27 — Template Decision Register (log tham vấn)
...
- Cột 'Lý do' giới hạn 2 dòng. Dài hơn thì link sang doc khác.
- Cột 'Chọn' chỉ 1 option. Nếu nhiều thì tách ID khác.
- Dòng nào 'Người duyệt' trống thì trạng thái = 'Cần duyệt'.
- Trạng thái: Đã chọn / Hoãn / Hủy / Cần duyệt — 4 giá trị.
```

📝 **Ghi chú VN:** DR đóng 3 vai: bằng chứng audit + tài liệu tiền đề tranh luận + tài liệu bàn giao. Retro hàng tuần check sót. Quyết định liên Phase bắt buộc DR hóa.
📝 **Ghi chú JP:** DR は『監査証跡 + 議論の前提資料 + 引き継ぎ素材』の3役を兼ねる。週次レトロで漏れチェック。Phase をまたぐ判断は必ず DR 化。

### Rule 39 — Team Hou-Ren-Sou Playbook (tóm tắt 1 trang)
...
[1 Rituals (định kỳ)]
  ...
  - All-hands hàng tháng thứ Hai đầu tháng 10:00-11:00
  - Drill Sev1 escalation hàng quý (simulation)
  - Họp đều có agenda + minutes → Notion

[2 Dashboard URL]
  - Notion 「Team Hou-Ren-Sou Dashboard」 https://notion.so/...
  - Hữu hình hóa: Slack response SLA / số Sev1 / DR coverage / phân bổ self-diagnostic
  - Tần suất update: tự động hàng tuần + review thủ công đầu tháng

[3 OKR (Q2-2026)]
  - O: Khách đánh giá 'quality team nhất quán'
    KR1: Slack response khách trong 1h ≥ 95%
    KR2: Sev1 escalation sót = 0
    KR3: Decision Register coverage 100% (1 tham vấn 1 dòng)
    KR4: Self-diagnostic C-D ≤ 1 trung bình team
    KR5: NPS khách ≥ 60

[4 Escalation Matrix]
  - Sự cố khách: BD owner → chị Hương → anh Hà CTO
  - Sev1 kỹ thuật: người phát hiện → anh Tuấn → anh Hà CTO
  - Kế toán / hợp đồng: người mở ticket → chị Loan → chị Hương
  - Nghỉ việc / nghỉ phép: bản thân → trực tiếp → anh Hà CTO + HR
  - Tất cả case: trace qua Slack channel #escalation

[5 Onboarding (kế hoạch 90 ngày)]
  - Day 1-7: Đọc xong toàn Playbook + cấp quyền Slack/Notion chính
  - Day 8-30: Shadow 5 case có sẵn (1-on-1 cùng mentor)
  - Day 31-60: Chủ động 3 case, self-diagnostic lần đầu
...
[Cách dùng Playbook]
  ...
  - All-hands hàng tháng vote Slack chọn 「Good Hou-Ren-Sou tháng này」 và 「Lesson tháng này」
  - Kết quả vote vào HR evaluation (trục Hou-Ren-Sou 20%)
  - Revise hàng quý, thảo luận trong retrospective
```

📝 **Ghi chú VN:** Bắt buộc Playbook 'gọn 1 trang'. Doc 50 trang không ai đọc. Dashboard là single source of truth cho số. OKR review mỗi quý.
