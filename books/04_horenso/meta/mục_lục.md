...
| 02 | Khuôn báo cáo tiến độ hằng ngày/hằng tuần | 進捗報告のフォーマット | Bố cục: Done / Doing / Blocked / Next. [TEMPLATE: report] |
| 03 | Cấu trúc báo cáo kết quả | 結果報告の組み立て (Goal→Result→Cause→Action) | Goal → Result → Cause → Action |
| 04 | Báo cáo trung gian | 中間報告 (mốc 25/50/75%) | Khi việc dài: chia mốc 25/50/75% mỗi mốc 1 update |
| 05 | Báo cáo hoàn thành | 完了報告 (Output→Acceptance→Lessons) | Output → Confirm acceptance → Lessons learned. [TEMPLATE: report] |
| 06 | Báo cáo có số liệu | 数字を使った報告 | KPI dashboard, % change, before/after |
| 07 | Báo cáo tin xấu | 悪い知らせの報告 (Predict→Fact→Impact→Plan→Ask) | Predict → Fact → Impact → Plan → Ask. [TEMPLATE: report] |
| 08 | Cách viết 報告書 | 報告書の書き方 (văn bản báo cáo công việc trang trọng) | Standard structure JP business document. [TEMPLATE: report] |
| 09 | Báo cáo miệng vs văn bản | 口頭報告 vs 書面報告 | Khi nào dùng cái nào |
| 10 | Báo cáo trong 朝礼 | 朝礼での報告 | 30-60 giây gọn |
| 11 | Báo cáo cho khách hàng quan trọng | 重要顧客への報告 | Tone formal cao, no jargon |
| 12 | Danh sách kiểm tra phòng ngừa thiếu báo cáo | 報告漏れ防止 | Danh sách tự kiểm + bảng theo dõi. [TEMPLATE: danh sách kiểm] |
...
| # | Tên VN | Tên JP | Brief |
|---|--------|--------|-------|
| 13 | Nguyên tắc liên lạc tức thì | 連絡の即時性原則 | "Thông tin chậm = thông tin sai" |
| 14 | Cấu trúc liên lạc toàn nhóm | 全員に届く連絡 | TL;DR đầu, detail sau, action item rõ |
| 15 | Chọn kênh: chat | mail | Decision matrix theo urgency × audience size |
| 16 | Phép lịch sự trên Slack | Slack マナー | @here / @channel / threads / DM khi nào |
...
| 19 | Báo vắng | 不在連絡 (休暇 | 24h trước, ai cover, return date |
| 20 | Báo công tác | 出張連絡 | Trước 1 tuần, agenda + deliverables + reachable |
| 21 | Liên lạc lệch múi giờ (VN-JP) | 海外チームへの時差連絡 | Ghi giờ UTC/JST, nhắn không đồng thời, bàn giao cuối ngày |
...
| 25 | Hỏi dữ kiện ra quyết định thay vì hỏi đáp án | 答えではなく判断材料を求める | "Em đang nghĩ A và B, anh thấy thế nào?" |
| 26 | Mang sẵn nhiều phương án | 複数案を持参 | Tối thiểu 2-3 options + đánh giá pros/cons |
| 27 | Lưu nhật ký tham vấn | 相談ログ | Decision register: ngày / vấn đề / phương án chọn / lý do. [TEMPLATE: report] |
...
| # | Tên VN | Tên JP | Brief |
|---|--------|--------|-------|
| 31 | Phát hiện bug — quy trình Hou-Ren-Sou | バグ発見時 | Phát hiện → Tuấn → Hà CTO → Matsumoto. Mốc thời gian cho từng bước |
| 32 | Khi khách phàn nàn — leo thang | クレームのエスカレーション | Junior nhận → Senior verify → Solution proposal |
| 33 | Báo nghỉ việc | nghỉ dài hạn | Notice timing, handover plan, documentation |
| 34 | Kèm cặp Hou-Ren-Sou cho nhân sự mới | 新人指導 | Dũng kèm Linh: 1-on-1 hằng tuần + giờ trực Slack |
| 35 | Hou-Ren-Sou khi làm từ xa | リモートワーク時 | Họp nhanh mỗi sáng, minh bạch trạng thái, nhật ký cuối ngày |
| 36 | Thu hẹp khoảng cách VN-JP về HouRenSou | VN-JP オフショア・ギャップ | VN có xu hướng "less = better"; Nhật ngược lại. Thích nghi |
...
| # | Tên VN | Tên JP | Brief |
|---|--------|--------|-------|
| 37 | Slack | Notion | Decision matrix |
| 38 | Tự chẩn đoán Hou-Ren-Sou | 自己診断 | Danh sách 15 mục tự chấm. [TEMPLATE: danh sách kiểm] |
| 39 | Xây dựng văn hóa Hou-Ren-Sou cấp team | チーム文化作り | Team-level playbook: rituals, dashboards, OKR. [TEMPLATE: report] |
| 40 | Hồi cố + cải tiến | 振り返りと改善 | Khuôn hồi cố hằng tuần. [TEMPLATE: danh sách kiểm] |
...
- **D** — Khuôn mẫu tổng hợp (~10 mẫu: báo cáo, danh sách kiểm, thư mời họp)
...
## 📐 Quy ước trình bày đặc thù sách 04
