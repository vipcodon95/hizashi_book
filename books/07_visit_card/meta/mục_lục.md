# Hizashi Sách 07 — Tiếp khách·Thăm·Danh thiếp / 来客・訪問・名刺交換 — Mục lục 35 rules

*Hizashi Teams. 2026.*

Sách dạy nghi thức gặp mặt offline với khách Nhật: nhận khách tại Việt Nam + thăm văn phòng khách tại Nhật + trao danh thiếp + tiếp đãi. Đặc thù JP: bow angle, seat order, omiyage, danh thiếp 3-bước, nệm/áo trang trọng.

**Đối tượng:** BD/PM/Account VN có cơ hội gặp khách Nhật offline, đi onsite Nhật. BJT J3-J2 場面把握 + 表現読解.

---

## 🎬 Cast & Bối cảnh

Cast như sách 06 + scenario:
- Dũng đi onsite 白鷗 ở Tokyo lần đầu (sau đàm phán Phase 3 thành)
- Nhận đoàn 大垣 + 松本 + 中村 đến HCMC visit
- Linh học bow + danh thiếp lần đầu
- Tuấn đi onsite cùng Dũng (technical kickoff)
- Hà CTO + Hương vào Tokyo cho final ceremony

---

## 📋 Cấu trúc 5 phần × 35 rules
...
## Phần I — Trao danh thiếp (名刺交換) — 7 rules

| # | Tên VN | Tên JP | Brief |
|---|--------|--------|-------|
| 01 | Chuẩn bị danh thiếp đúng cách | 名刺の準備 | Hộp riêng, mặt JP, đủ số, kiểm tra lỗi typo [TEMPLATE: checklist] |
...
## Phần II — Tiếp khách tại VN (来客対応) — 8 rules
...
## Phần III — Thăm văn phòng khách JP (訪問) — 8 rules
...
| 22 | Đi quanh văn phòng / nhà máy | 工場・社内案内 | Theo guide, không tự ý mở cửa |
| 23 | Rời văn phòng trang trọng | 退室マナー | Đứng dậy, bow, tay chỉ lối ra |

---

## Phần IV — Tiếp đãi · Bữa ăn · Omiyage — 7 rules
...
## Phần V — Tình huống đặc biệt + Self-improve — 5 rules
...
- B — Vocab tổng hợp (~150-180 từ)
- C — BJT practice (35 câu, J3-J2)
- D — Templates (~5 templates) + diagram refs (bow angle, seat layout, danh thiếp flow)
...
- Sách 03: rule_11 名刺交換 ↔ rule_03 sách 07
- Sách 03: rule_06 5分前到着 ↔ rule_17 sách 07
- Sách 06: rule_36 商談成立後 ↔ rule_24 sách 07 接待
