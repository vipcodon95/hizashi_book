---
title: "Hizashi — Tiếp khách·Thăm·Danh thiếp / 来客・訪問・名刺交換 v1.1"
...
35 rules dạy nghi thức gặp mặt offline với khách Nhật. Đặc thù JP: bow angle, seat order (上座/下座), omiyage, danh thiếp 4 điều kiện.

**Đối tượng:** BD/PM/Account VN có cơ hội gặp khách Nhật offline + đi onsite Nhật. BJT J3-J2.
...
- Đoàn 大垣 + 松本 + 中村CFO + 田中PMO đến HCMC visit (rule 02-15 + rule 24-30)
- Dũng + Tuấn đi onsite Tokyo (rule 16-23, rule 31-35)
- Linh học bow + danh thiếp lần đầu (arc xuyên suốt)
...
>
> 🇻🇳 *Thứ tự: junior trước, bên khách thì người cấp cao nhất exchange trước.*
>
> 📝 _順序ブリーフィング_
...
> 🇯🇵 「ロビーまでお見送りさせていただきます。」
>
> 🇻🇳 *Em xin phép tiễn các anh xuống lobby ạ.*
>
> 📝 _見送り宣言固定句_
...
### Rule 14 — After-care (theo dõi sau visit) / アフターケア

**リン (em Linh):**

> 🇯🇵 「3要素チェック済: quote、action item、personal note。」
>
> 🇻🇳 *Đã check 3 yếu tố: quote, action, personal note.*
>
> 📝 _アフターケア3要素確認_
...
>
> 🇻🇳 *Mục tiêu đến trụ sở 白鷗 9:55, vào lobby trước 5 phút.*
>
> 📝 _5-10分前到着逆算プラン_
...
>
> 🇻🇳 *Bow có 4 loại: eshaku 15°, keirei 30°, saikeirei 45°, xin lỗi 90°.*
>
> 📝 _4角度の summary_
...
| 名刺 | めいし | Danh thiếp | rule_01 |
| 名刺入れ | めいしいれ | Hộp đựng danh thiếp | rule_01 |
| 両面 | りょうめん | Hai mặt | rule_01 |
...
| 角 | かど | Góc (của danh thiếp) | rule_02 |
| 役職 | やくしょく | Chức vụ | rule_02 |
| 確認 | かくにん | Xác nhận | rule_02 |
| 儀式 | ぎしき | Nghi lễ | rule_02 |
| 申し上げる | もうしあげる | (kính ngữ của 言う) Nói (khiêm nhường) | rule_03 |
| 部署 | ぶしょ | Phòng ban | rule_03 |
| 氏名 | しめい | Họ tên | rule_03 |
| お辞儀 | おじぎ | Cúi chào | rule_03 |
| 15度 | じゅうごど | 15 độ (bow nhẹ) | rule_03 |
| フルネーム | furu neemu | Họ tên đầy đủ | rule_03 |
| 自己紹介 | じこしょうかい | Tự giới thiệu | rule_03 |
| 同時交換 | どうじこうかん | Trao đổi đồng thời | rule_04 |
| 右手 | みぎて | Tay phải | rule_04 |
| 左手 | ひだりて | Tay trái | rule_04 |
| 低く | ひくく | Thấp | rule_04 |
| 高く | たかく | Cao | rule_04 |
| 持ち直す | もちなおす | Cầm lại / chuyển tay | rule_04 |
| お先にどうぞ | おさきにどうぞ | Mời anh/chị trước | rule_04 |
| 立場 | たちば | Vị trí / vai vế | rule_05 |
| 順序 | じゅんじょ | Thứ tự | rule_05 |
| 下位者 | かいしゃ | Người cấp thấp | rule_05 |
| 上位者 | じょういしゃ | Người cấp cao | rule_05 |
| 最上位 | さいじょうい | Cấp cao nhất | rule_05 |
| 最後 | さいご | Cuối cùng | rule_05 |
| 申し訳ございません | もうしわけございません | Vô cùng xin lỗi (kính ngữ) | rule_05 |
| マトリクス | matorikusu | Ma trận | rule_05 |
| 机上 | きじょう | Trên bàn | rule_06 |
| 配置 | はいち | Bố trí | rule_06 |
| 座席順 | ざせきじゅん | Thứ tự chỗ ngồi | rule_06 |
| 重ねる | かさねる | Xếp chồng | rule_06 |
| 仕舞う | しまう | Cất đi | rule_06 |
| 退室 | たいしつ | Rời phòng | rule_06 |
| 並べる | ならべる | Sắp xếp | rule_06 |
| 中央 | ちゅうおう | Trung tâm | rule_06 |
| 管理 | かんり | Quản lý | rule_07 |
| 入力 | にゅうりょく | Nhập (data) | rule_07 |
| 文脈 | ぶんみゃく | Bối cảnh | rule_07 |
| メモ | memo | Memo / ghi chú | rule_07 |
| スキャン | sukyan | Scan | rule_07 |
| クラウド | kuraudo | Cloud | rule_07 |
| 共有 | きょうゆう | Chia sẻ | rule_07 |
| 締切 | しめきり | Deadline | rule_07 |
| 曖昧 | あいまい | Mơ hồ | rule_07 |
| 関心事 | かんしんごと | Vấn đề quan tâm | rule_07 |
...
| 内線 | ないせん | Số nội bộ | rule_08 |
| ロビー | robii | Lobby | rule_08 |
| 受付 | うけつけ | Lễ tân | rule_08 |
| 待機 | たいき | Chờ / standby | rule_08 |
...
| 操作盤 | そうさばん | Bảng điều khiển (thang máy) | rule_09 |
| 会議室 | かいぎしつ | Phòng họp | rule_09 |
| 廊下 | ろうか | Hành lang | rule_09 |
| ノック | nokku | Gõ cửa | rule_09 |
| 参る | まいる | (khiêm nhường của 行く) Đi | rule_09 |
| 上座 | かみざ | Kamiza (chỗ trang trọng, xa cửa) | rule_10 |
| 下座 | しもざ | Shimoza (chỗ gần cửa, host) | rule_10 |
| お掛けください | おかけください | Mời ngồi (kính ngữ) | rule_10 |
| 出入口 | でいりぐち | Cửa ra vào | rule_10 |
| 壁背 | かべせ | Lưng dựa tường | rule_10 |
| 座席 | ざせき | Chỗ ngồi | rule_10 |
| お茶 | おちゃ | Trà | rule_11 |
...
| 着席 | ちゃくせき | Ngồi xuống | rule_11 |
| 順番 | じゅんばん | Thứ tự | rule_11 |
| 右側 | みぎがわ | Bên phải | rule_11 |
...
| スコープ | sukoopu | Scope | rule_12 |
| お見送り | おみおくり | Tiễn khách (kính ngữ) | rule_13 |
| させていただきます | させていただきます | Xin phép làm... (kính ngữ) | rule_13 |
| 玄関 | げんかん | Cửa chính | rule_13 |
| お車 | おくるま | Xe (kính ngữ) | rule_13 |
| ご用意 | ごようい | Chuẩn bị (kính ngữ) | rule_13 |
| お気をつけて | おきをつけて | Đi cẩn thận (kính ngữ) | rule_13 |
| 恐縮 | きょうしゅく | Thật ngại / quá lịch sự | rule_13 |
| アフターケア | afutaa kea | After-care | rule_14 |
| お礼メール | おれいめーる | Mail cảm ơn | rule_14 |
| 件名 | けんめい | Tiêu đề (mail) | rule_14 |
| 議事録 | ぎじろく | Biên bản meeting | rule_14 |
| ご送付 | ごそうふ | Gửi (kính ngữ) | rule_14 |
| 添付 | てんぷ | Đính kèm | rule_14 |
| 署名 | しょめい | Chữ ký (mail) | rule_14 |
| 名義 | めいぎ | Tên đại diện | rule_14 |
| キックオフ | kikkuofu | Kickoff | rule_14 |
| 早退 | そうたい | Đến/về sớm | rule_15 |
| 遅刻 | ちこく | Muộn | rule_15 |
| お早いお越し | おはやいおこし | Đến sớm (kính ngữ) | rule_15 |
| お通しいたします | おとおしいたします | Em xin đưa vào (kính ngữ) | rule_15 |
| 渋滞 | じゅうたい | Tắc đường | rule_15 |
...
| 漢字 / Tiếng Nhật | Cách đọc (Romaji) | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|
| 訪問 | ほうもん | Thăm / visit | rule_16 |
| 担当者 | たんとうしゃ | Người phụ trách | rule_16 |
| 確認メール | かくにんめーる | Mail xác nhận | rule_16 |
| ルート | ruuto | Route | rule_16 |
| バッファ | baffa | Buffer | rule_16 |
| ICカード | aishii kaado | IC card (Suica/Pasmo) | rule_16 |
| お土産 | おみやげ | Quà (omiyage) | rule_16 |
| 濃紺 | のうこん | Xanh đậm | rule_16 |
| ネクタイ | nekutai | Cravate | rule_16 |
| 5-10分前 | 5〜10ぷんまえ | 5-10 phút trước | rule_17 |
| 到着 | とうちゃく | Đến | rule_17 |
| 目標 | もくひょう | Mục tiêu | rule_17 |
| 出発 | しゅっぱつ | Xuất phát | rule_17 |
| 時間調整 | じかんちょうせい | Điều chỉnh thời gian | rule_17 |
| 早すぎ | はやすぎ | Quá sớm | rule_17 |
| 定刻 | ていこく | Đúng giờ | rule_17 |
| 実質 | じっしつ | Thực chất | rule_17 |
| 入館証 | にゅうかんしょう | Thẻ vào (pass) | rule_18 |
| 御芳名 | ごほうめい | Tên quý khách (kính ngữ) | rule_18 |
| 用件 | ようけん | Lý do / việc | rule_18 |
...
| コート | kooto | Áo khoác | rule_19 |
| マフラー | mafuraa | Khăn quàng | rule_19 |
| 脱ぐ | ぬぐ | Cởi | rule_19 |
| 畳む | たたむ | Gấp | rule_19 |
| 左腕 | ひだりうで | Cẳng tay trái | rule_19 |
| ハンガー | hangaa | Móc treo | rule_19 |
| お預かり | おあずかり | Em xin giữ giúp (kính ngữ) | rule_19 |
| 入室 | にゅうしつ | Vào phòng | rule_19 |
| お掛けになる | おかけになる | Ngồi (kính ngữ) | rule_20 |
| 正座 | せいざ | Tư thế ngồi nghiêm | rule_20 |
| 姿勢 | しせい | Tư thế | rule_20 |
| お時間頂戴 | おじかんちょうだい | Xin được dành thời gian | rule_20 |
| 間もなく | まもなく | Sắp đến | rule_20 |
| 閉扉 | へいひ | Đóng cửa | rule_21 |
| 後ろ手 | うしろで | Tay sau lưng | rule_21 |
| 敷居 | しきい | Ngưỡng cửa | rule_21 |
| 静かに | しずかに | Im lặng / nhẹ nhàng | rule_21 |
| お入りください | おはいりください | Mời vào (kính ngữ) | rule_21 |
| 工場 | こうじょう | Nhà máy | rule_22 |
| 社内 | しゃない | Trong cty | rule_22 |
| 案内 | あんない | Dẫn / tour | rule_22 |
| 撮影 | さつえい | Chụp ảnh | rule_22 |
| 許可 | きょか | Cho phép | rule_22 |
| 機器 | きき | Thiết bị | rule_22 |
| 隣室 | りんしつ | Phòng kế bên | rule_22 |
| 立入禁止 | たちいりきんし | Cấm vào | rule_22 |
| 通りすぎる | とおりすぎる | Đi qua | rule_22 |
| 構図 | こうず | Bố cục (ảnh) | rule_22 |
| 起立 | きりつ | Đứng dậy | rule_23 |
| 出口 | でぐち | Lối ra | rule_23 |
| 振り返る | ふりかえる | Quay đầu lại | rule_23 |
| 貴重な | きちょうな | Quý báu | rule_23 |
...
| 漢字 / Tiếng Nhật | Cách đọc (Romaji) | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|
| 接待 | せったい | Tiếp khách | rule_24 |
| 個室 | こしつ | Phòng riêng | rule_24 |
| 食事制限 | しょくじせいげん | Hạn chế ăn uống / dị ứng | rule_24 |
| 甲殻類 | こうかくるい | Giáp xác | rule_24 |
| 送迎 | そうげい | Đưa đón | rule_24 |
| 手配 | てはい | Sắp xếp / đặt | rule_24 |
...
| 中座 | ちゅうざ | Rời bàn giữa chừng | rule_25 |
| 乾杯 | かんぱい | Cụng ly / kanpai | rule_26 |
| 発声 | はっせい | Hô (lời chúc) | rule_26 |
...
| 雑談 | ざつだん | Trò chuyện ngẫu nhiên | rule_27 |
| お召し上がり | おめしあがり | Đang dùng (kính ngữ) | rule_27 |
| 風味 | ふうみ | Vị / hương vị | rule_27 |
| 週末 | しゅうまつ | Cuối tuần | rule_27 |
| 趣味 | しゅみ | Sở thích | rule_27 |
| 雨季 | うき | Mùa mưa | rule_27 |
| お越しの際 | おこしのさい | Khi sang / khi đến | rule_27 |
| つまらないもの | つまらないもの | Vật không đáng gì | rule_28 |
| 紙袋 | かみぶくろ | Túi giấy | rule_28 |
| 差し出す | さしだす | Đưa ra | rule_28 |
| 召し上がる | めしあがる | Dùng / ăn (kính ngữ) | rule_28 |
| お心遣い | おこころづかい | Tấm lòng / sự quan tâm | rule_28 |
| 高地 | こうち | Vùng cao | rule_28 |
| 羊羹 | ようかん | Yokan (bánh ngọt) | rule_29 |
| 日持ち | ひもち | Để được lâu | rule_29 |
| 後ほど | のちほど | Lát nữa / sau | rule_29 |
| 御礼 | おれい | Lời cảm ơn | rule_29 |
| 御礼メール | おれいメール | Mail cảm ơn | rule_30 |
| 昨夜 | さくや | Tối qua | rule_30 |
| 頂戴 | ちょうだい | Nhận (kính ngữ) | rule_30 |
...
| 漢字 / Tiếng Nhật | Cách đọc (Romaji) | Nghĩa Việt | Lần đầu xuất hiện |
|------|------|------|------|
| 席札 | せきふだ | Bảng tên ghế | rule_31 |
| 席次表 | せきじひょう | Sơ đồ chỗ ngồi | rule_31 |
| 歓談 | かんだん | Trò chuyện thân mật | rule_31 |
| 締め | しめ | Kết thúc | rule_31 |
| 会釈 | えしゃく | Bow nhẹ 15° | rule_32 |
| 敬礼 | けいれい | Bow chuẩn 30° | rule_32 |
| 最敬礼 | さいけいれい | Bow kính cẩn 45° | rule_32 |
| 謝罪 | しゃざい | Xin lỗi | rule_32 |
| 反省 | はんせい | Suy ngẫm / ăn năn | rule_32 |
...
| 違和感 | いわかん | Cảm giác lạ / không tự nhiên | rule_33 |
| 居酒屋 | いざかや | Quán nhậu casual Nhật | rule_33 |
| 相互 | そうご | Lẫn nhau / hỗ tương | rule_33 |
| 両替 | りょうがえ | Đổi tiền | rule_34 |
| 折りたたみ傘 | おりたたみがさ | Ô gấp | rule_34 |
| 持参 | じさん | Mang theo | rule_34 |
| 折り目 | おりめ | Vết gấp / nhăn | rule_34 |
| 拒否 | きょひ | Từ chối | rule_34 |
| 改札 | かいさつ | Cổng soát vé | rule_34 |
| 残高 | ざんだか | Số dư | rule_34 |
| 振り返り | ふりかえり | Self-review / nhìn lại | rule_35 |
| 課題 | かだい | Vấn đề / việc cần giải quyết | rule_35 |
| 改善 | かいぜん | Cải thiện | rule_35 |
| 期限 | きげん | Deadline | rule_35 |
| 記録 | きろく | Ghi chép / lưu hồ sơ | rule_35 |
| 文章化 | ぶんしょうか | Viết thành văn bản | rule_35 |
| 過ち | あやまち | Lỗi | rule_35 |
...
- A) 週末にまとめて CRM 入力
- **B) 24時間以内に CRM 入力 + 文脈メモ1行 + スキャン + フォロー送信**
- C) 名刺ケースに保管のみ
- D) 次回会った時に再確認
...
- 🇻🇳 Quy tắc 24h. Não giữ >80% context trong 24h.
...
- 🇻🇳 Senior khách trước → hierarchy khách → hierarchy host. Đặt bên phải 2 tay.
...
- 🇻🇳 Cởi trước khi vào để không mang khí ngoài vào phòng họp. Cởi sau khi ngồi = signaling 'mệt'.
...
- A) その場で開封して中身を確認
- B) 値段や購入先を尋ねる
- **C) 両手で受け取り『頂戴いたします』+お辞儀30°、開封は後で社内で**
- D) 片手で受け取って机にバラ置き
...
- A) 3日後にBCC一括で短文送信
- **B) 翌朝24h以内、To個別+CC上司、具体的話題引用、次回約束を含む**
- C) 送らない (口頭でお礼済)
- D) 1週間後に詳細な議事録のみ
...
- A) 現地ATMで現金引き出し前提で日本円ゼロで出発
- B) Narita空港でお土産購入前提
- **C) 現金5万円・お土産・eSIM/Wi-Fi・スーツwrinkle対策をVN出発前に完了**
- D) スーツはspray対応、お土産は現地で
...
- A) 右手で受け取り、左手で渡す
- **B) 右手で自分の名刺を低く差し出し、左手で相手の名刺を高く受ける**
- C) 両手で同時に渡し合う
- D) どちらの手でもよい
...
- A) 副部長が先頭でCFOから交換
- **B) intern → BD → Lead → 副部長 の順、各自CFOから交換**
- C) ランダムでよい
- D) 客側部長から先に交換
...
- 🇻🇳 Ma trận: junior bên mình trước, senior bên khách ưu tiên.
...
- 🇻🇳 Trung tâm 上座 = senior nhất. Phải > Trái về cấp.
...
- A) 天気・移動・宿泊
- **B) specific quote + action item + personal note**
- C) 会社紹介・商品PR・次回提案
- D) 謝罪・釈明・改善
...
- 🇻🇳 Quote = chứng minh đã nghe, action = follow-up, personal note = build relationship. 3 yếu tố bắt buộc.
...
- A) 案内された椅子(中央)に座る
- **B) 下座で待つと宣言し、phone/laptop OFF で待機**
- C) 好きな席に座って自分の仕事をする
- D) 立ったまま待ち続ける
...
- A) 黙って撮影する
- B) 撮影後に『撮りました』と報告
- **C) 事前に『お写真を撮ってもよろしいでしょうか』と許可を求める**
- D) 案内終了後に許可を取る
...
- A) 予約・menu指定・割り勘
- **B) order・pour・pay の3つを host 側が全責任**
- C) 客にmenuを渡し選んでもらう
- D) alcohol を客に注がせる
...
- 🇻🇳 Thấp hơn senior = kính trọng. Không kêu, chạm nhẹ thôi.
...
- 🇻🇳 Lấy ra khỏi túi → hướng chữ về khách → 2 tay → câu khiêm nhường → trao theo thứ tự senior — combo 4 điểm.
...
- A) 自由着席で柔軟性を確保
- B) 1人ですべてのpourを担当
- **C) 席札+席次表+zone別pour担当+flow table の4点を事前準備**
- D) flow を当日ad-libで進行
...
- A) 自分のglassに自分で注ぐ
- B) 招待されても自分が支払うと主張
- C) 受け取ったgiftにその場で同等のお返しを渡す
- **D) 相互pour・招待者支払いを尊重・お返しは次回または別日**
