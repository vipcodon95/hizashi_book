...
function Table(el)
  ...
  -- Vai|Lời thoại / Vai|Câu (20/80) và 漢字|よみ|Nghĩa (30/30/40): để CSS selector mặc định xử lý
  if hkey == "Vai|Lời thoại" or hkey == "Vai|Câu" or hkey == "漢字|よみ|Nghĩa" then
    return el
  end
  -- Bảng từ vựng 4 cột → 22/22/22/34 (cố định)
  if hkey == "Từ|Cách đọc|Hán Việt|Nghĩa tiếng Việt"
      or hkey == "Từ|Cách đọc|Hán Việt|Nghĩa Việt" then
