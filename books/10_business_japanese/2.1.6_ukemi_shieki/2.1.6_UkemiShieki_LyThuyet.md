...
> ⚠️ **Với 他動詞**: **LUÔN** dùng **に** cho người bị sai (không dùng を cho người, chỉ を cho tân ngữ)
...
| Bị động (sản phẩm làm chủ ngữ) | 報告書が田中によって書かれた。| Báo cáo được viết bởi Tanaka |
