---
title: "Hizashi — Đàm phán·Đề xuất / 商談・交渉"
...
45 quy tắc dạy cách đàm phán hợp đồng với khách hàng: từ chuẩn bị BATNA/ZOPA, tìm hiểu nhu cầu, thương lượng giá và phạm vi, đến chốt kèo và soạn hợp đồng. Đặc thù Nhật: quy trình duyệt nội bộ (稟議 — ringi), dùng im lặng làm công cụ, nguyên tắc nhượng bộ có qua có lại.

**Đối tượng:** Chuyên viên kinh doanh / phụ trách khách hàng người Việt đàm phán hợp đồng với khách hàng. Ôn thi BJT J2-J1.
...
| II | Mở đàm phán & Tìm hiểu nhu cầu | 8 |
| III | Đàm phán giá & phạm vi | 12 |
| IV | Chốt kèo & Hợp đồng | 10 |
| V | Tình huống đặc biệt & Tự hoàn thiện | 6 |

**Phụ lục:** A (tổng hợp mẫu câu), B (từ vựng), C (luyện BJT 45 câu), D (tổng hợp mẫu).

## Nhân vật nâng cấp

- **大垣 — Trưởng phòng kinh doanh (Ōgaki)** — đối thủ đàm phán sắc sảo, xuyên suốt phần lớn quyển sách.
- **中村 — Giám đốc tài chính (Nakamura)** — tham gia các vòng định giá cuối quan trọng.
- **Em Linh** — học cách làm việc qua phiên dịch (rule 42).

## Bản quyền

© 2026 Hizashi Teams. Sáng tác gốc.

*Hizashi — Tia nắng đầu ngày trong từng cuộc đàm phán của bạn.*



# Phần I — Trước đàm phán (準備)
...
| 取り下げ | とりさげ | THỦ HẠ | Rút lại |



# Phần II — Mở đàm phán & Tìm hiểu nhu cầu
...
# Rule 12 — Câu hỏi tìm hiểu nhu cầu: 5 nhóm / ディスカバリー質問
...
| 契約期間延長 | けいやくきかんえんちょう | KHẾ ƯỚC KỲ GIAN DIÊN TRƯỜNG | Kéo dài thời hạn hợp đồng |
...
| 整理する | せいりする | CHỈNH LÝ | Sắp xếp / tổng hợp |


# Rule 25 — Im lặng như vũ khí / 沈黙の活用
...
| 再協議 | さいきょうぎ | TÁI HIỆP NGHỊ | Thảo luận lại |
...
| 再 review | さいレビュー | — | Xem lại |



# Phần IV — Chốt kèo & Hợp đồng
...
# Rule 32 — LOI trước, soạn hợp đồng sau / 契約書ドラフト・LOI
...
(Mẫu LOI 1-2 trang JP/VN với 6 phần điều khoản thương mại — xem hướng dẫn đính kèm cuốn sách)
...
| 半端な | はんぱな | — | Nửa vời |
| 再検討 | さいけんとう | TÁI KIỂM THẢO | Xem xét lại |
...
(Mẫu thông cáo báo chí JP với các phần Tiêu đề / Dẫn nhập / Nội dung / Trích dẫn / Giới thiệu công ty — xem hướng dẫn đính kèm cuốn sách)


# Rule 39 — Cảm ơn toàn bộ chuỗi liên quan / 関係者への感謝
...
*Mỗi cụm có thể dùng để luyện phát âm audio.*
...
>
>  *Em đã tạo BATNA 3 kịch bản ạ. Phiền chị duyệt giúp em được không ạ?*
>
>  _BATNA レビュー依頼の標準_
...
>
>  *Không vào đàm phán khi chưa có BATNA. 3 kịch bản (đạt thương vụ / đề đối / điểm rút lui) phải có con số.*
>
>  _BATNA原則_
...
>
>  *Em đã lập bản đồ ZOPA. Mục tiêu bên em ¥18M, trần ước của khách ¥17M ạ.*
>
>  _ZOPA レポートの標準_
...
>
>  *ZOPA bằng 0 thì hôm nay không có thương vụ. Bắt buộc ước tính đủ 4 con số.*
>
>  _ZOPA原則_
...
>
>  *Em đã cập nhật bảng thông tin 4 trục của Hakuō. Em báo cáo theo thứ tự người duyệt/ngân sách/đối thủ/kết quả kinh doanh ạ.*
>
>  _顧客インテル報告の標準_
...
>
>  *Better tier ¥18M, kèm Best tier ¥24M làm neo giá, em mang theo làm tài liệu xem xét ạ.*
>
>  _go first 二段anchor_
...
>
>  *Để khớp ngân sách quý cty, cần điều chỉnh phạm vi ạ.*
>
>  _scope転換 標準フレーズ_
...
>
>  *Em xin tách cost từng mục. Tổng 〇〇¥, theo gói là 〇〇¥ ạ.*
>
...
>
>  _kết thúc trung tính khi rút lui_
...
>
>  *Nếu phía em muốn, có (A) thêm có phí, (B) đánh đổi trong phạm vi hiện tại — hai cách đều được ạ.*
>
...
>
>  *Xem xét yếu tố bổ sung thì cần duyệt lại toàn bộ thỏa thuận ạ.*
>
>  _reset clock 警告_
...
>
>  *Nếu mình đánh đổi bằng cách đưa 1 trong 2 ra ngoài phạm vi thì có thể điều chỉnh xuống ¥18M ạ.*
>
...
>  *Nếu mình ~, có thể ~.*
>
>  _Cách diễn đạt giả định "nếu mình~"_
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Rule |
|------|------|------|------|------|
| BATNA | BATNA | — | Best Alternative To Negotiated Agreement | rule_01 |
| 撤退 | てったい | TRIỆT THOÁI | Rút lui (rời bàn đàm phán) | rule_01 |
| 譲歩 | じょうほ | NHƯỢNG BỘ | Nhượng bộ / concession | rule_01 |
| 利益率 | りえきりつ | LỢI ÍCH SUẤT | Tỷ suất lợi nhuận | rule_01 |
| 内部承認 | ないぶしょうにん | NỘI BỘ THỪA NHẬN | Phê duyệt nội bộ | rule_01 |
| シナリオ | シナリオ | — | Scenario | rule_01 |
| MoU | MoU | — | Memorandum of Understanding | rule_01 |
| ZOPA | ZOPA | — | Zone Of Possible Agreement | rule_02 |
| 合意可能領域 | ごういかのうりょういき | HỢP Ý KHẢ NĂNG LĨNH VỰC | Vùng có thể thỏa thuận | rule_02 |
| 目標価格 | もくひょうかかく | MỤC TIÊU GIÁ CÁCH | Giá mục tiêu | rule_02 |
| 撤退価格 | てったいかかく | TRIỆT THOÁI GIÁ CÁCH | Giá giới hạn rút lui | rule_02 |
| 予算上限 | よさんじょうげん | DỰ TOÁN THƯỢNG HẠN | Trần ngân sách | rule_02 |
| 着地点 | ちゃくちてん | TRƯỚC ĐỊA ĐIỂM | Landing point / điểm chốt | rule_02 |
| アンカー | アンカー | — | Giá neo (giá mở) | rule_02 |
| 稟議 | りんぎ | BẨM NGHỊ | Ringi (văn bản chuyền tay xin duyệt) | rule_03 |
| 稟議書 | りんぎしょ | BẨM NGHỊ THƯ | Tài liệu ringi | rule_03 |
| 根回し | ねまわし | — | Nemawashi (vận động ngầm trước họp) | rule_03 |
| 決裁 | けっさい | QUYẾT TÀI | Sếp ký duyệt cuối | rule_03 |
| 即決 | そっけつ | TỨC QUYẾT | Quyết định ngay | rule_03 |
| 催促 | さいそく | THÔI XÚC | Hối thúc, đòi | rule_03 |
| 進捗 | しんちょく | TIẾN TIỆP | Tiến độ | rule_03 |
| 決裁ライン | けっさいライン | QUYẾT TÀI — | Đường duyệt / decision-maker line | rule_04 |
| 予算サイクル | よさんサイクル | DỰ TOÁN — | Chu kỳ ngân sách | rule_04 |
| 直近業績 | ちょっきんぎょうせき | TRỰC CẬN NGHIỆP TÍCH | Kết quả kinh doanh gần đây | rule_04 |
| 営業利益 | えいぎょうりえき | DOANH NGHIỆP LỢI ÍCH | Lợi nhuận hoạt động | rule_04 |
| コスト圧縮 | コストあっしゅく | — ÁP SÚC | Cắt giảm chi phí | rule_04 |
| 段階導入 | だんかいどうにゅう | ĐOẠN GIAI ĐẠO NHẬP | Triển khai theo giai đoạn | rule_04 |
| インテル | インテル | — | Intel (intelligence) | rule_04 |
| 原価 | げんか | NGUYÊN GIÁ | Giá vốn / cost | rule_05 |
| 粗利率 | あらりりつ | THÔ LỢI SUẤT | Lợi nhuận gộp | rule_05 |
| 価値ベース | かちベース | GIÁ TRỊ — | Định giá theo giá trị | rule_05 |
| 戦略案件 | せんりゃくあんけん | CHIẾN LƯỢC ÁN KIỆN | Thương vụ chiến lược | rule_05 |
| 商品案件 | しょうひんあんけん | THƯƠNG PHẨM ÁN KIỆN | Thương vụ hàng hóa phổ thông | rule_05 |
| インパクト | インパクト | — | Tác động | rule_05 |
| 3段階提案 | さんだんかいていあん | — ĐOẠN GIAI ĐỀ ÁN | Đề xuất 3 bậc | rule_06 |
| 推奨 / おすすめ | すいしょう | SUY TƯỞNG | Khuyến nghị | rule_06 |
| 中間案 | ちゅうかんあん | TRUNG GIAN ÁN | Phương án giữa | rule_06 |
| 専任 | せんにん | CHUYÊN NHẬM | Chuyên trách | rule_06 |
| 常駐 | じょうちゅう | THƯỜNG TRÚ | Túc trực | rule_06 |
| 機能削減 | きのうさくげん | CƠ NĂNG TƯỚC GIẢM | Cắt giảm chức năng | rule_06 |
| 比較表 | ひかくひょう | TỈ GIẢO BIỂU | Bảng so sánh | rule_06 |
| すり合わせ | すりあわせ | — | Thống nhất / họp align trước đàm phán | rule_07 |
| 役割確認 | やくわりかくにん | DỊCH CÁT XÁC NHẬN | Xác nhận vai trò | rule_07 |
| 譲歩順序 | じょうほじゅんじょ | NHƯỢNG BỘ THUẬN TỰ | Thứ tự nhượng bộ | rule_07 |
| 撤退ライン | てったいライン | TRIỆT THOÁI — | Mức rút lui (giới hạn rời bàn) | rule_07 |
| エスカレーション | エスカレーション | — | Trình lên cấp trên (escalation) | rule_07 |
| 沈黙の合図 | ちんもくのあいず | — | Tín hiệu im lặng | rule_07 |
| 一致させる | いっちさせる | NHẤT TRÍ — | Làm cho đồng nhất | rule_07 |
| 知財 / IP | ちざい | TRI TÀI | Intellectual Property | rule_08 |
| 所有権 | しょゆうけん | SỞ HỮU QUYỀN | Quyền sở hữu | rule_08 |
| white-label | white-label | — | OEM / nhãn trắng | rule_08 |
| 罰則賠償 | ばっそくばいしょう | PHẠT TẮC BỒI THƯỜNG | Phạt vi phạm / bồi thường | rule_08 |
| 支払条件 | しはらいじょうけん | CHI PHẤT ĐIỀU KIỆN | Điều kiện thanh toán | rule_08 |
| 責任上限 | せきにんじょうげん | TRÁCH NHẬM THƯỢNG HẠN | Giới hạn trách nhiệm | rule_08 |
| 競業避止 | きょうぎょうひし | CẠNH NGHIỆP TỴ CHỈ | Điều khoản không cạnh tranh | rule_08 |
| 譲歩計画 | じょうほけいかく | NHƯỢNG BỘ KẾ HOẠCH | Kế hoạch nhượng bộ | rule_09 |
| 引き換え | ひきかえ | — | Điều kiện đổi | rule_09 |
| 段階的譲歩 | だんかいてきじょうほ | ĐOẠN GIAI ĐÍCH NHƯỢNG BỘ | Nhượng bộ theo bậc thang | rule_09 |
| 契約期間 | けいやくきかん | KHẾ ƯỚC KỲ GIAN | Thời hạn hợp đồng | rule_09 |
| LTV | LTV | — | Lifetime Value | rule_09 |
| 事例公開 | じれいこうかい | SỰ LỆ CÔNG KHAI | Công bố tình huống thực tế | rule_09 |
| 値引き | ねびき | TRỊ DẪN | Giảm giá | rule_09 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Rule |
|------|------|------|------|------|
| 商談冒頭 | しょうだんぼうとう | THƯƠNG ĐÀM MẠO ĐẦU | Mở đàm phán | rule_10 |
| お忙しい中 | おいそがしいなか | — | Trong lúc bận rộn | rule_10 |
| 改めまして | あらためまして | — | Một lần nữa | rule_10 |
| 拝見する | はいけんする | BÁI KIẾN — | Xem (kính ngữ) | rule_10 |
| 忌憚ない | きたんない | KỴ ĐÀM — | Thẳng thắn / không kiêng | rule_10 |
| 意見 | いけん | Ý KIẾN | Ý kiến | rule_10 |
| DX 推進 | DXすいしん | — SUY TIẾN | Đẩy mạnh DX | rule_10 |
| 立場 | たちば | LẬP TRƯỜNG | Vị thế / lập trường | rule_10 |
| 振り返り | ふりかえり | — | Điểm lại / nhìn lại | rule_11 |
| 経緯 | けいい | KINH VĨ | Diễn biến / quá trình | rule_11 |
| 直近 | ちょっきん | TRỰC CẬN | Gần đây | rule_11 |
| アジェンダ | アジェンダ | — | Chương trình nghị sự (agenda) | rule_11 |
| ディスカッション | ディスカッション | — | Thảo luận | rule_11 |
| 念頭に置く | ねんとうにおく | NIỆM ĐẦU — | Lưu ý / để trong đầu | rule_11 |
| 共通認識 | きょうつうにんしき | CỘNG THÔNG NHẬN THỨC | Nhận thức chung | rule_11 |
| 観点 | かんてん | QUAN ĐIỂM | Góc nhìn / trục khai thác | rule_12 |
| 課題 | かだい | KHÓA ĐỀ | Vấn đề / điểm đau | rule_12 |
| 在庫予測 | ざいこよそく | TẠI KHỐ DỰ TRẮC | Dự báo tồn kho | rule_12 |
| 手動調整 | しゅどうちょうせい | THỦ ĐỘNG ĐIỀU CHỈNH | Điều chỉnh thủ công | rule_12 |
| 予算感 | よさんかん | DỰ TOÁN CẢM | Cảm giác về ngân sách | rule_12 |
| 稟議経路 | りんぎけいろ | BẨM NGHỊ KINH LỘ | Đường ringi | rule_12 |
| 合議 | ごうぎ | HỢP NGHỊ | Quyết định tập thể | rule_12 |
| 取締役会 | とりしまりやくかい | THỦ ĐẾ DỊCH HỘI | HĐQT / board | rule_12 |
| 隠れた制約 | かくれたせいやく | — CHẾ ƯỚC | Ràng buộc ẩn | rule_13 |
| 議論 | ぎろん | NGHỊ LUẬN | Bàn luận / bất đồng quan điểm | rule_13 |
| 慎重 | しんちょう | THẬN TRỌNG | Thận trọng | rule_13 |
| 漏洩リスク | ろうえいリスク | LẬU TIẾT — | Rủi ro rò rỉ | rule_13 |
| 説明可能性 | せつめいかのうせい | THUYẾT MINH KHẢ NĂNG TÍNH | Khả năng giải thích (của model) | rule_13 |
| 余裕を持たせる | よゆうをもたせる | DƯ DỤ — | Để dư địa | rule_13 |
| 稟議の助け | りんぎのたすけ | BẨM NGHỊ — | Hỗ trợ ringi | rule_13 |
| ミラーリング | ミラーリング | — | Phản chiếu | rule_14 |
| 要約 | ようやく | YẾU ƯỚC | Tóm tắt | rule_14 |
| 認識 | にんしき | NHẬN THỨC | Nhận thức | rule_14 |
| 確認 | かくにん | XÁC NHẬN | Xác nhận | rule_14 |
| trade-off | trade-off | — | Đánh đổi | rule_14 |
| 超過 | ちょうか | SIÊU QUÁ | Vượt quá | rule_14 |
| 超えなくて大丈夫 | こえなくてだいじょうぶ | — | Không cần vượt quá | rule_14 |
| 価格感度 | かかくかんど | GIÁ CÁCH CẢM ĐỘ | Mức độ nhạy cảm giá | rule_15 |
| 位置付け | いちづけ | VỊ TRÍ PHÓ | Vị thế / positioning | rule_15 |
| 帯域 | たいいき | ĐỚI VỰC | Dải | rule_15 |
| 規模感 | きぼかん | QUY MÔ CẢM | Cảm giác quy mô | rule_15 |
| 想定 | そうてい | TƯỞNG ĐỊNH | Giả định / dự kiến | rule_15 |
| 中位 | ちゅうい | TRUNG VỊ | Mức trung vị | rule_15 |
| 決裁者 | けっさいしゃ | QUYẾT TÀI GIẢ | Người duyệt | rule_16 |
| 最終決裁 | さいしゅうけっさい | TỐI CHUNG QUYẾT TÀI | Duyệt cuối | rule_16 |
| 取締役会付議 | とりしまりやくかいふぎ | THỦ ĐẾ DỊCH HỘI PHÓ NGHỊ | Đưa lên HĐQT | rule_16 |
| 技術 review | ぎじゅつレビュー | KỸ THUẬT — | Review kỹ thuật | rule_16 |
| 予算審議 | よさんしんぎ | DỰ TOÁN THẨM NGHỊ | Thẩm định ngân sách | rule_16 |
| 法務 check | ほうむチェック | PHÁP VỤ — | Pháp chế kiểm tra | rule_16 |
| 経理部 | けいりぶ | KINH LÝ BỘ | Phòng kế toán | rule_16 |
| 時間管理 | じかんかんり | THỜI GIAN QUẢN LÝ | Quản lý thời gian | rule_17 |
| そろそろ | そろそろ | — | Có lẽ giờ / sắp đến lúc | rule_17 |
| 移らせていただく | うつらせていただく | DI — | Cho phép em chuyển | rule_17 |
| 提案の概要 | ていあんのがいよう | ĐỀ ÁN KHÁI YẾU | Tổng quan đề xuất | rule_17 |
| 再学習頻度 | さいがくしゅうひんど | TÁI HỌC TẬP TẦN ĐỘ | Tần suất huấn luyện lại | rule_17 |
| 経過 | けいか | KINH QUÁ | Đã trôi qua | rule_17 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Rule |
|------|------|------|------|------|
| アンカリング | アンカリング | — | Neo giá | rule_18 |
| 足元を見られる | あしもとをみられる | TÚC NGUYÊN — | Bị bắt thóp | rule_18 |
| 根拠 | こんきょ | CĂN CỨ | Cơ sở / lý do | rule_18 |
| 構成 | こうせい | CẤU THÀNH | Cấu thành | rule_18 |
| ROI 倍率 | ROIばいりつ | — BỘI SUẤT | Bội số ROI | rule_18 |
| 議論が必要 | ぎろんがひつよう | NGHỊ LUẬN — TẤT YẾU | Cần thảo luận | rule_18 |
| 効果 | こうか | HIỆU QUẢ | Hiệu lực | rule_18 |
| 価格提示 | かかくていじ | GIÁ CÁCH ĐỀ THỊ | Đề xuất giá | rule_19 |
| ご指摘 | ごしてき | CHỈ TRÍCH | Lời nhận xét (kính ngữ) | rule_19 |
| もっとも | もっとも | — | Có lý / hợp lý | rule_19 |
| 構成見直し | こうせいみなおし | CẤU THÀNH — | Xem lại cấu thành | rule_19 |
| 流用 | りゅうよう | LƯU DỤNG | Tận dụng / dùng lại | rule_19 |
| 工数 | こうすう | CÔNG SỐ | Ngày công / nỗ lực | rule_19 |
| 契約期間延長 | けいやくきかんえんちょう | KHẾ ƯỚC KỲ GIAN DIÊN TRƯỜNG | Kéo dài thời hạn hợp đồng | rule_19 |
| 高い | たかい | — | Đắt | rule_20 |
| 角度 | かくど | GIÁC ĐỘ | Góc nhìn | rule_20 |
| 別の角度から | べつのかくどから | BIỆT GIÁC ĐỘ — | Từ góc nhìn khác | rule_20 |
| 運用工数 | うんようこうすう | VẬN DỤNG CÔNG SỐ | Công sức vận hành | rule_20 |
| 在庫調整 | ざいこちょうせい | TẠI KHỐ ĐIỀU CHỈNH | Điều chỉnh tồn kho | rule_20 |
| net positive | net positive | — | Net dương | rule_20 |
| 予算面 | よさんめん | DỰ TOÁN DIỆN | Mặt ngân sách | rule_20 |
| 持ち帰り検討 | もちかえりけんとう | — KIỂM THẢO | Mang về xem xét | rule_20 |
| スコープ | スコープ | — | Phạm vi | rule_21 |
| 調整 | ちょうせい | ĐIỀU CHỈNH | Điều chỉnh | rule_21 |
| 後出し | あとだし | — | Đẩy về sau | rule_21 |
| カスタム部分 | カスタムぶぶん | — BỘ PHÂN | Phần tùy biến | rule_21 |
| 半常駐 | はんじょうちゅう | BÁN THƯỜNG TRÚ | Bán-túc trực | rule_21 |
| 単価 | たんか | ĐƠN GIÁ | Đơn giá | rule_21 |
| 同等 | どうとう | ĐỒNG ĐẲNG | Tương đương | rule_21 |
| 復活 | ふっかつ | PHỤC HOẠT | Khôi phục | rule_21 |
| バンドリング | バンドリング | — | Gộp gói | rule_22 |
| アンバンドリング | アンバンドリング | — | Tách từng mục | rule_22 |
| 個別 cost | こべつコスト | CÁ BIỆT — | Chi phí từng mục | rule_22 |
| パッケージディスカウント | パッケージディスカウント | — | Chiết khấu gói | rule_22 |
| 共通基盤化 | きょうつうきばんか | CỘNG THÔNG CƠ BÀN HÓA | Xây trên nền chung | rule_22 |
| 還元 | かんげん | HOÀN NGUYÊN | Hoàn lại / chia sẻ | rule_22 |
| ラインアイテム | ラインアイテム | — | Dòng ngân sách / hạng mục | rule_22 |
| 投資 | とうし | ĐẦU TƯ | Đầu tư | rule_23 |
| 年間リターン | ねんかんリターン | NIÊN GIAN — | Lợi tức hàng năm | rule_23 |
| 回収期間 | かいしゅうきかん | HỒI THU KỲ GIAN | Thời gian thu hồi vốn | rule_23 |
| 割引率 | わりびきりつ | CÁT DẪN SUẤT | Tỉ lệ chiết khấu | rule_23 |
| 上振れ | うわぶれ | — | Vượt dự kiến | rule_23 |
| 第三者監査 | だいさんしゃかんさ | ĐỆ TAM GIẢ GIÁM TRA | Kiểm toán bên thứ ba | rule_23 |
| 控制された外挿 | せいぎょされたがいそう | — NGOẠI TIẾP | Ngoại suy có kiểm soát | rule_23 |
| 譲歩交換 | じょうほこうかん | NHƯỢNG BỘ GIAO HOÁN | Đổi nhượng bộ | rule_24 |
| お取り計らい | おとりはからい | — | Sắp xếp / hỗ trợ | rule_24 |
| 条項 | じょうこう | ĐIỀU KHOẢN | Điều khoản | rule_24 |
| 自動更新 | じどうこうしん | TỰ ĐỘNG CẬP TÂN | Tự động gia hạn | rule_24 |
| 公式事例 | こうしきじれい | CÔNG THỨC SỰ LỆ | Case tình huống chính thức | rule_24 |
| 広報部 | こうほうぶ | QUẢNG BÁO BỘ | Phòng PR | rule_24 |
| 整理する | せいりする | CHỈNH LÝ — | Sắp xếp / tổng hợp | rule_24 |
| 沈黙 | ちんもく | TRẦM MẶC | Im lặng | rule_25 |
| 思考時間 | しこうじかん | TƯ KHẢO THỜI GIAN | Thời gian suy nghĩ | rule_25 |
| 自爆 | じばく | TỰ BỘC | Tự bùng (tự gây hại) | rule_25 |
| ハードル | ハードル | — | Rào / khó khăn | rule_25 |
| 調整余地 | ちょうせいよち | ĐIỀU CHỈNH DƯ ĐỊA | Dư địa điều chỉnh | rule_25 |
| 口を封じる | くちをふうじる | KHẨU PHONG — | Khoá miệng | rule_25 |
| 脅し | おどし | — | Đe dọa | rule_26 |
| 最終通告 | さいしゅうつうこく | TỐI CHUNG THÔNG CÁO | Tối hậu thư | rule_26 |
| 粗利を割り込む | あらりをわりこむ | — | Phá ngưỡng lợi nhuận gộp | rule_26 |
| 致しかねます | いたしかねます | CHÍ — | Khó thực hiện được | rule_26 |
| 達成度合い | たっせいどあい | ĐẠT THÀNH ĐỘ — | Mức độ đạt được | rule_26 |
| 再アンカリング | さいアンカリング | TÁI — | Neo giá lại | rule_27 |
| 改めて整理 | あらためてせいり | — CHỈNH LÝ | Sắp xếp lại | rule_27 |
| 追加情報 | ついかじょうほう | TRUY GIA TÌNH BÁO | Thông tin thêm | rule_27 |
| 上方修正 | じょうほうしゅうせい | THƯỢNG PHƯƠNG TU CHÍNH | Điều chỉnh tăng | rule_27 |
| 社内検証 | しゃないけんしょう | XÃ NỘI KIỂM CHỨNG | Kiểm chứng nội bộ | rule_27 |
| 期待値 | きたいち | KỲ ĐÃI TRỊ | Giá trị kỳ vọng | rule_27 |
| 社内ハードル | しゃないハードル | XÃ NỘI — | Rào nội bộ | rule_27 |
| 再協議 | さいきょうぎ | TÁI HIỆP NGHỊ | Thảo luận lại | rule_27 |
| 折り合いがつかない | おりあいがつかない | — | Không khớp | rule_28 |
| 誠に残念 | まことにざんねん | THÀNH — TÁN NIỆM | Thật tiếc | rule_28 |
| クローズ | クローズ | — | Khép lại / kết thúc | rule_28 |
| ご縁 | ごえん | DUYÊN | Mối duyên / kết nối | rule_28 |
| 貴重な経験 | きちょうなけいけん | QUÝ TRỌNG KINH NGHIỆM | Trải nghiệm quý | rule_28 |
| 事業環境 | じぎょうかんきょう | SỰ NGHIỆP HOÀN CẢNH | Môi trường kinh doanh | rule_28 |
| 歓迎 | かんげい | HOAN NGHÊNH | Hoan nghênh | rule_28 |
| ニブル | ニブル | — | Yêu cầu nhỏ gặm thêm | rule_29 |
| ついでに | ついでに | — | Tiện thể | rule_29 |
| サービスで | サービスで | — | Khuyến mãi miễn phí | rule_29 |
| 全体合意 | ぜんたいごうい | TOÀN THỂ HỢP Ý | Đồng thuận tổng thể | rule_29 |
| 後ろ倒し | うしろだおし | — | Đẩy lùi (deadline) | rule_29 |
| 抑止力 | よくしりょく | ỨC CHỈ LỰC | Sức răn đe | rule_29 |
| 再 review | さいレビュー | TÁI — | Xem lại | rule_29 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Rule |
|------|------|------|------|------|
| 合意事項 | ごういじこう | HỢP Ý SỰ HẠNG | Các điểm đã đồng thuận | rule_30 |
| 読み戻し | よみもどし | — | Đọc lại xác nhận | rule_30 |
| 齟齬 | そご | TRỞ NGỮ | Sự sai lệch / không khớp | rule_30 |
| 月末締め | げつまつじめ | NGUYỆT MẠT — | Chốt cuối tháng | rule_30 |
| 翌月末払い | よくげつまつばらい | DỰC NGUYỆT MẠT PHẤT — | Trả cuối tháng kế | rule_30 |
| 共同所有 | きょうどうしょゆう | CỘNG ĐỒNG SỞ HỮU | Đồng sở hữu | rule_30 |
| 概ね | おおむね | KHÁI — | Đại thể | rule_30 |
| 要約メール | ようやくメール | YẾU ƯỚC — | Mail tóm tắt | rule_31 |
| 確認メール | かくにんメール | XÁC NHẬN — | Mail xác nhận | rule_31 |
| 出席者 | しゅっせきしゃ | XUẤT TỊCH GIẢ | Người tham dự | rule_31 |
| 未決事項 | みけつじこう | VỊ QUYẾT SỰ HẠNG | Các mục chưa quyết | rule_31 |
| 次のアクション | つぎのアクション | — | Bước tiếp theo | rule_31 |
| 上申 | じょうしん | THƯỢNG THÂN | Đệ trình lên cấp trên | rule_31 |
| 添付 | てんぷ | THIÊM PHÓ | Đính kèm | rule_31 |
| LOI | LOI | — | Letter of Intent | rule_32 |
| 基本合意書 | きほんごういしょ | CƠ BẢN HỢP Ý THƯ | Văn bản đồng thuận cơ bản (LOI theo thuật ngữ Nhật) | rule_32 |
| 捺印 | なついん | NẠP ẤN | Ký và đóng dấu | rule_32 |
| 本契約書 | ほんけいやくしょ | BẢN KHẾ ƯỚC THƯ | Hợp đồng chính | rule_32 |
| 主要条件 | しゅようじょうけん | CHỦ YẾU ĐIỀU KIỆN | Điều khoản thương mại cốt lõi | rule_32 |
| 効力発生日 | こうりょくはっせいび | HIỆU LỰC PHÁT SINH NHẬT | Ngày có hiệu lực | rule_32 |
| 法務 | ほうむ | PHÁP VỤ | Bộ phận pháp chế | rule_32 |
| 税抜 | ぜいぬき | THUẾ BẠT | Chưa bao gồm thuế | rule_32 |
| 損害賠償 | そんがいばいしょう | TỔN HẠI BỒI THƯỜNG | Bồi thường thiệt hại | rule_33 |
| 上限 | じょうげん | THƯỢNG HẠN | Mức trần | rule_33 |
| 帰属 | きぞく | QUY THUỘC | Thuộc về | rule_33 |
| 知的財産 | ちてきざいさん | TRI ĐÍCH TÀI SẢN | Sở hữu trí tuệ | rule_33 |
| 罰則 | ばっそく | PHẠT TẮC | Phạt vi phạm | rule_33 |
| 業界標準 | ぎょうかいひょうじゅん | NGHIỆP GIỚI TIÊU CHUẨN | Chuẩn ngành | rule_33 |
| ライセンス供与 | ライセンスきょうよ | — CUNG DỰ | Cấp phép sử dụng | rule_33 |
| 営業日 | えいぎょうび | DOANH NGHIỆP NHẬT | Ngày làm việc | rule_33 |
| 調印 | ちょういん | ĐIỀU ẤN | Ký kết (trang trọng) | rule_34 |
| ご署名 | ごしょめい | THỬ DANH | Ký tên (kính ngữ) | rule_34 |
| ご捺印 | ごなついん | NẠP ẤN | Đóng dấu (kính ngữ) | rule_34 |
| 業務委託契約書 | ぎょうむいたくけいやくしょ | NGHIỆP VỤ ỦY THÁC KHẾ ƯỚC THƯ | Hợp đồng giao việc | rule_34 |
| 原本 | げんぽん | NGUYÊN BẢN | Bản gốc | rule_34 |
| eSignature | eSignature | — | Chữ ký điện tử | rule_34 |
| 締結 | ていけつ | ĐẾ KẾT | Ký kết | rule_34 |
...
| 原価構造 | げんかこうぞう | NGUYÊN GIÁ CẤU TẠO | Cấu trúc giá thành | rule_35 |
| 半端な | はんぱな | — | Nửa vời | rule_35 |
| 再検討 | さいけんとう | TÁI KIỂM THẢO | Xem xét lại | rule_35 |
| 身の引き締まる思い | みのひきしまるおもい | — | Cảm thấy trách nhiệm nặng nề | rule_36 |
| 御礼 | おんれい | NGỰ LỄ | Lời cảm ơn (formal) | rule_36 |
| 頂戴 | ちょうだい | ĐỈNH ĐỚI | Nhận (kính ngữ) | rule_36 |
| 全力でお取組み | ぜんりょくでおとりくみ | TOÀN LỰC — | Toàn lực cam kết | rule_36 |
| 信頼 | しんらい | TÍN LẠI | Tin tưởng | rule_36 |
| 段取り | だんどり | ĐOẠN — | Sắp xếp | rule_36 |
| キックオフ | キックオフ | — | Khởi động dự án | rule_37 |
| 引き継ぎ | ひきつぎ | — | Bàn giao | rule_37 |
| 内訳 | うちわけ | NỘI DỊCH | Cấu thành / breakdown | rule_37 |
| commitment | コミットメント | — | Cam kết | rule_37 |
| reliability budget | リライアビリティバジェット | — | Ngân sách độ tin cậy | rule_37 |
| 同期 | どうき | ĐỒNG KỲ | Đồng bộ | rule_37 |
| 対外発表 | たいがいはっぴょう | ĐỐI NGOẠI PHÁT BIỂU | Công bố ra ngoài | rule_38 |
| プレスリリース | プレスリリース | — | Thông cáo báo chí | rule_38 |
| 数千万円規模 | すうせんまんえんきぼ | SỐ THIÊN VẠN VIÊN QUY MÔ | Quy mô vài chục triệu yên | rule_38 |
| Embargo | エンバーゴ | — | Thời điểm phát hành đã định | rule_38 |
| 同時 release | どうじリリース | ĐỒNG THỜI — | Phát hành đồng thời | rule_38 |
| Joint quote | ジョイントクオート | — | Trích dẫn chung | rule_38 |
| 体裁 | ていさい | THỂ TÀI | Hình thức / dáng vẻ | rule_38 |
| 文言 | もんごん | VĂN NGÔN | Câu chữ / cách dùng từ | rule_38 |
| 関係者 | かんけいしゃ | QUAN HỆ GIẢ | Người liên quan | rule_39 |
| お力添え | おちからぞえ | LỰC THIÊM — | Sự giúp sức (formal) | rule_39 |
| 細やか | こまやか | TẾ — | Tỉ mỉ | rule_39 |
| 指摘 | してき | CHỈ TRÍCH | Chỉ ra / nêu ra điểm cần lưu ý | rule_39 |
| 死角 | しかく | TỬ GIÁC | Điểm mù | rule_39 |
| support function | サポートファンクション | — | Bộ phận hỗ trợ (kế toán, pháp chế) | rule_39 |
| 個別 | こべつ | CÁ BIỆT | Riêng từng người | rule_39 |
...
| Từ | Cách đọc | Hán Việt | Nghĩa Việt | Rule |
|------|------|------|------|------|
| 多者間 | たしゃかん | ĐA GIẢ GIAN | Đa bên | rule_40 |
| 並列 | へいれつ | TỊNH LIỆT | Song song | rule_40 |
| 保守延長 | ほしゅえんちょう | BẢO THỦ DIÊN TRƯỜNG | Gia hạn bảo trì | rule_40 |
| Payback period | ペイバック・ピリオド | — | Thời gian hoàn vốn | rule_40 |
| 純利益 | じゅんりえき | THUẦN LỢI ÍCH | Lợi nhuận ròng | rule_40 |
| 別枠 | べつわく | BIỆT — | Khung riêng | rule_40 |
| 専任 PM | せんにん PM | CHUYÊN NHẬM — | PM chuyên trách | rule_40 |
| Reliability budget | リライアビリティ・バジェット | — | Ngân sách độ tin cậy | rule_40 |
| カメラ直視 | カメラちょくし | — TRỰC THỊ | Nhìn thẳng camera | rule_41 |
| 画面共有 | がめんきょうゆう | HỌA DIỆN CỘNG HỮU | Chia sẻ màn hình | rule_41 |
| 凝視 | ぎょうし | NGƯNG THỊ | Nhìn chằm chằm, nhìn cố định | rule_41 |
| 沈黙保持 | ちんもくほじ | TRẦM MẶC BẢO TRÌ | Giữ im lặng | rule_41 |
| ネット遅延 | ネットちえん | — TRÌ DIÊN | Độ trễ mạng (lag mạng) | rule_41 |
...
| 通訳 | つうやく | THÔNG DỊCH | Phiên dịch | rule_42 |
| 介在 | かいざい | GIỚI TẠI | Trung gian | rule_42 |
| 区切り発音 | くぎりはつおん | KHU THIẾT PHÁT ÂM | Phát âm tách rõ | rule_42 |
| Pre-brief | プレ・ブリーフ | — | Brief trước | rule_42 |
| Ear-shot 距離 | イアショット きょり | — CỰ LY | Khoảng cách nghe rõ | rule_42 |
| Memory buffer | メモリーバッファ | — | Bộ nhớ tạm | rule_42 |
| Improv ミス | インプロビザミス | — | Lỗi ứng phó tự phát | rule_42 |
| 権限を超えます | けんげんをこえます | QUYỀN HẠN — | Vượt thẩm quyền | rule_43 |
| 取締役会規定 | とりしまりやくかいきてい | THỦ ĐẾ DỊCH HỘI QUY ĐỊNH | Quy định HĐQT | rule_43 |
| 段階的 cap | だんかいてき cap | ĐOẠN GIAI ĐÍCH — | Giới hạn trách nhiệm theo bậc | rule_43 |
| Trigger | トリガー | — | Tín hiệu kích hoạt | rule_43 |
| Microexpression | マイクロエクスプレッション | — | Biểu cảm vi mô | rule_43 |
| Step-in | ステップイン | — | Cấp trên bước vào | rule_43 |
| 直接 | ちょくせつ | TRỰC TIẾP | Trực tiếp | rule_44 |
| 間接 | かんせつ | GIÁN TIẾP | Gián tiếp | rule_44 |
| Reciprocal | レシプロカル | — | Có qua có lại | rule_44 |
| Ratchet effect | ラチェット効果 | — HIỆU QUẢ | Hiệu ứng bánh cóc (giảm rồi không lên lại) | rule_44 |
| Code-switch | コードスイッチ | — | Chuyển phong cách | rule_44 |
| Unbundle | アンバンドル | — | Tách ra | rule_44 |
| Realtime coach | リアルタイムコーチ | — | Coach trực tiếp tại chỗ | rule_44 |
| Post-mortem | ポストモーテム | — | Buổi đánh giá hậu sự kiện | rule_45 |
| Counterfactual | カウンターファクチュアル | — | Giả định ngược | rule_45 |
| Pattern | パターン | — | Mô hình lặp lại | rule_45 |
| Commit | コミット | — | Cam kết | rule_45 |
| Pocket card | ポケットカード | — | Card bỏ túi | rule_45 |
| Adherence | アドヒアレンス | — | Mức độ tuân thủ | rule_45 |
| Habit 化 | habitか | — HÓA | Thói quen hóa | rule_45 |
| Psychological safety | 心理的安全性 | TÂM LÝ ĐÍCH AN TOÀN TÍNH | An toàn tâm lý | rule_45 |
...
| Mục | Nội dung |
|-----|----------|
| Tên sách | Hizashi — Đàm phán·Đề xuất / 商談・交渉 |
