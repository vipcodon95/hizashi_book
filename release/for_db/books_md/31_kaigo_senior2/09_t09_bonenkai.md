# Sách điều dưỡng viên quốc gia · T9. Tiệc cuối năm và sự trưởng thành của thực tập sinh (忘年会と実習生の成長)
...
> Từ vựng & mẫu câu: 忘年会・乾杯の音頭を取る・教育担当・実習生・定着率・指導マニュアル・介護主任・施設全体・振り返り・課題・改善計画・技能実習3号・自立・不安は大切・よいお年を
